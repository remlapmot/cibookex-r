...
save ./data/fig3, replace

scatter Y A, ylab(0(50)250) xlab(0(10)100) xscale(range(0 100))
gr export figs/stata-fig-11-3.png, replace
```
...
gr export figs/stata-fig-11-4.png, replace
```
...
gr export figs/stata-fig-11-5.png, replace
```
