...
\begin{verbatim}
##                         V1             mean                se               ll
## 1                 Observed 2.56188497106103  0.24668184067209 2.07839744770369
## 2             No Treatment 1.65212306626746 0.178514468087165 1.30224113809729
## 3                Treatment 5.11474489549347 0.522570364036168 4.09052580259459
## 4 Treatment - No Treatment 3.46262182922601 0.435119993683595 2.60980231265286
##                 ul
## 1 3.04537249441838
## 2 2.00200499443763
## 3 6.13896398839234
...
\begin{verbatim}
##                         V1             mean                se               ll
## 1                 Observed 2.63384609228479 0.192406725801889 2.25673583932982
## 2             No Treatment 1.71983636149843 0.158859463475949 1.40847753448221
## 3                Treatment 5.35072300362993 0.366605477687233 4.63218947082785
## 4 Treatment - No Treatment 3.63088664213151 0.401165530794113 2.84461664993615
##                 ul
## 1 3.01095634523977
## 2 2.03119518851464
## 3 6.06925653643201
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{di}\NormalTok{ c(}\KeywordTok{version}\NormalTok{)}
\KeywordTok{di}\NormalTok{ c(born\_date)}
\end{Highlighting}
\end{Shaded}
