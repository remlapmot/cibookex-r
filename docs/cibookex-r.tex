...
\DocumentationTok{\#\# A            2.602e{-}16  3.608e{-}01   0.000    1.000}
\DocumentationTok{\#\# L            4.167e{-}01  3.898e{-}01   1.069    0.301}
\DocumentationTok{\#\# A:L         {-}3.237e{-}16  4.959e{-}01   0.000    1.000}
\DocumentationTok{\#\# }
...
\DocumentationTok{\#\# 1                 Observed 2.56188497106103 0.166759462538625 2.23504243040407}
\DocumentationTok{\#\# 2             No Treatment 1.65212306626748 0.218888477867158 1.22310953301706}
\DocumentationTok{\#\# 3                Treatment  5.1147448954934 0.344569425114411 4.43940123209548}
\DocumentationTok{\#\# 4 Treatment {-} No Treatment 3.46262182922592 0.439020375326088 2.60215770510753}
\DocumentationTok{\#\#                 ul}
\DocumentationTok{\#\# 1 2.88872751171799}
\DocumentationTok{\#\# 2  2.0811365995179}
\DocumentationTok{\#\# 3 5.79008855889132}
\DocumentationTok{\#\# 4 4.32308595334431}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{bootstrap}
\DocumentationTok{\#\#                         V1             mean                se               ll}
\DocumentationTok{\#\# 1                 Observed 2.63384609228479  0.10931939139797 2.41958402233293}
\DocumentationTok{\#\# 2             No Treatment 1.71983636149845  0.20560687972976 1.31685428225446}
\DocumentationTok{\#\# 3                Treatment 5.35072300362985 0.293832115555194 4.77482263964046}
\DocumentationTok{\#\# 4 Treatment {-} No Treatment  3.6308866421314 0.433679379340606 2.78089067778612}
\DocumentationTok{\#\#                 ul}
\DocumentationTok{\#\# 1 2.84810816223665}
\DocumentationTok{\#\# 2 2.12281844074244}
\DocumentationTok{\#\# 3 5.92662336761924}
\DocumentationTok{\#\# 4 4.48088260647667}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# 2.621386 , 4.509942}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\#  version  R version 4.3.2 (2023{-}10{-}31 ucrt)}
...
\DocumentationTok{\#\#  date     2023{-}11{-}01}
...
\DocumentationTok{\#\#  bookdown      0.36    2023{-}10{-}16 [1] CRAN (R 4.3.1)}
\DocumentationTok{\#\#  cli           3.6.1   2023{-}03{-}23 [1] CRAN (R 4.3.0)}
\DocumentationTok{\#\#  digest        0.6.33  2023{-}07{-}07 [1] CRAN (R 4.3.1)}
\DocumentationTok{\#\#  evaluate      0.22    2023{-}09{-}29 [1] CRAN (R 4.3.1)}
\DocumentationTok{\#\#  fastmap       1.1.1   2023{-}02{-}24 [1] CRAN (R 4.3.0)}
\DocumentationTok{\#\#  htmltools     0.5.6.1 2023{-}10{-}06 [1] CRAN (R 4.3.1)}
...
\DocumentationTok{\#\#  [2] C:/Program Files/R/R{-}4.3.2/library}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\end{Highlighting}
\end{Shaded}
...
Available physical memory:   21.12 GB
...
\NormalTok{ version  R version }\DecValTok{4}\NormalTok{.}\FloatTok{3.2}\NormalTok{ (}\DecValTok{2023{-}10{-}31}\NormalTok{ ucrt)}
...
\NormalTok{ date     }\DecValTok{2023{-}11{-}01}
...
\NormalTok{ bookdown        }\FloatTok{0.36}    \DecValTok{2023{-}10{-}16}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{3.1}\NormalTok{)}
...
\NormalTok{ evaluate        }\FloatTok{0.22}    \DecValTok{2023{-}09{-}29}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{3.1}\NormalTok{)}
...
\NormalTok{ htmltools       }\DecValTok{0}\NormalTok{.}\DecValTok{5}\NormalTok{.}\FloatTok{6.1} \DecValTok{2023{-}10{-}06}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{3.1}\NormalTok{)}
...
\NormalTok{ Statamarkdown }\SpecialCharTok{*} \DecValTok{0}\NormalTok{.}\FloatTok{8.0}   \DecValTok{2023{-}06{-}01}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{3.1}\NormalTok{)}
...
\NormalTok{ [}\DecValTok{2}\NormalTok{] C}\SpecialCharTok{:}\ErrorTok{/}\NormalTok{Program Files}\SpecialCharTok{/}\NormalTok{R}\SpecialCharTok{/}\NormalTok{R}\DecValTok{{-}4}\NormalTok{.}\FloatTok{3.2}\SpecialCharTok{/}\NormalTok{library}
