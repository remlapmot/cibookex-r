...
\DocumentationTok{\#\# 1                 Observed 2.56188497106099 0.211466508861832 2.14741822975538}
\DocumentationTok{\#\# 2             No Treatment 1.65212306626744 0.164767148206081 1.32918538994814}
\DocumentationTok{\#\# 3                Treatment 5.11474489549336 0.552536991463512 4.03179229209876}
\DocumentationTok{\#\# 4 Treatment {-} No Treatment 3.46262182922592 0.452600564824252  2.5755410227879}
\DocumentationTok{\#\#                 ul}
\DocumentationTok{\#\# 1  2.9763517123666}
\DocumentationTok{\#\# 2 1.97506074258673}
\DocumentationTok{\#\# 3 6.19769749888795}
\DocumentationTok{\#\# 4 4.34970263566394}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{bootstrap}
\DocumentationTok{\#\#                         V1             mean                se               ll}
\DocumentationTok{\#\# 1                 Observed 2.63384609228479 0.136189863967758 2.36691886384858}
\DocumentationTok{\#\# 2             No Treatment 1.71983636149845 0.121717749635858 1.48127395593291}
\DocumentationTok{\#\# 3                Treatment 5.35072300362985  0.44628129313471 4.47602774211186}
\DocumentationTok{\#\# 4 Treatment {-} No Treatment  3.6308866421314 0.335317983371602 2.97367547135446}
\DocumentationTok{\#\#                 ul}
\DocumentationTok{\#\# 1 2.90077332072101}
\DocumentationTok{\#\# 2   1.958398767064}
\DocumentationTok{\#\# 3 6.22541826514785}
\DocumentationTok{\#\# 4 4.28809781290834}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# 2.572271 , 4.626295}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\#  version  R version 4.3.3 (2024{-}02{-}29)}
\DocumentationTok{\#\#  os       macOS Sonoma 14.3.1}
...
\DocumentationTok{\#\#  date     2024{-}03{-}02}
\DocumentationTok{\#\#  pandoc   3.1.12.1 @ /opt/homebrew/bin/ (via rmarkdown)}
\DocumentationTok{\#\# }
...
\DocumentationTok{\#\#  xfun          0.42    2024{-}02{-}08 [1] CRAN (R 4.3.2)}
...
\NormalTok{ version  R version }\DecValTok{4}\NormalTok{.}\FloatTok{3.3}\NormalTok{ (}\DecValTok{2024{-}02{-}29}\NormalTok{)}
\NormalTok{ os       macOS Sonoma }\DecValTok{14}\NormalTok{.}\FloatTok{3.1}
...
\NormalTok{ date     }\DecValTok{2024{-}03{-}02}
\NormalTok{ pandoc   }\DecValTok{3}\NormalTok{.}\DecValTok{1}\NormalTok{.}\FloatTok{12.1} \SpecialCharTok{@} \ErrorTok{/}\NormalTok{opt}\SpecialCharTok{/}\NormalTok{homebrew}\SpecialCharTok{/}\NormalTok{bin}\SpecialCharTok{/}\NormalTok{ (via rmarkdown)}
...
\NormalTok{ xfun            }\FloatTok{0.42}    \DecValTok{2024{-}02{-}08}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{3.2}\NormalTok{)}
