...
\DocumentationTok{\#\# 1                 Observed 2.56188497106099 0.202735202876936 2.16453127502377}
\DocumentationTok{\#\# 2             No Treatment 1.65212306626744 0.202832725422884 1.25457822955248}
\DocumentationTok{\#\# 3                Treatment 5.11474489549336 0.417676016586298 4.29611494577806}
\DocumentationTok{\#\# 4 Treatment {-} No Treatment 3.46262182922592 0.455181675409663 2.57048213900038}
\DocumentationTok{\#\#                 ul}
\DocumentationTok{\#\# 1  2.9592386670982}
\DocumentationTok{\#\# 2 2.04966790298239}
\DocumentationTok{\#\# 3 5.93337484520865}
\DocumentationTok{\#\# 4 4.35476151945146}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{bootstrap}
\DocumentationTok{\#\#                         V1             mean                se               ll}
\DocumentationTok{\#\# 1                 Observed 2.63384609228479 0.301757959061969 2.04241136047502}
\DocumentationTok{\#\# 2             No Treatment 1.71983636149845 0.246825644197991 1.23606698840949}
\DocumentationTok{\#\# 3                Treatment 5.35072300362985 0.207596203763713 4.94384192092574}
\DocumentationTok{\#\# 4 Treatment {-} No Treatment  3.6308866421314 0.155221039634026 3.32665899480584}
\DocumentationTok{\#\#                 ul}
\DocumentationTok{\#\# 1 3.22528082409456}
\DocumentationTok{\#\# 2 2.20360573458741}
\DocumentationTok{\#\# 3 5.75760408633397}
\DocumentationTok{\#\# 4 3.93511428945695}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# 2.651479 , 4.423129}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\#  os       macOS Sonoma 14.1.2}
...
\DocumentationTok{\#\#  date     2023{-}12{-}05}
\DocumentationTok{\#\#  pandoc   3.1.9 @ /opt/homebrew/bin/ (via rmarkdown)}
\DocumentationTok{\#\# }
...
\DocumentationTok{\#\#  rlang         1.1.2   2023{-}11{-}04 [1] CRAN (R 4.3.2)}
...
\NormalTok{ os       macOS Sonoma }\DecValTok{14}\NormalTok{.}\FloatTok{1.2}
...
\NormalTok{ date     }\DecValTok{2023{-}12{-}05}
\NormalTok{ pandoc   }\DecValTok{3}\NormalTok{.}\FloatTok{1.9} \SpecialCharTok{@} \ErrorTok{/}\NormalTok{opt}\SpecialCharTok{/}\NormalTok{homebrew}\SpecialCharTok{/}\NormalTok{bin}\SpecialCharTok{/}\NormalTok{ (via rmarkdown)}
...
\NormalTok{ rlang           }\DecValTok{1}\NormalTok{.}\FloatTok{1.2}   \DecValTok{2023{-}11{-}04}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{3.2}\NormalTok{)}
