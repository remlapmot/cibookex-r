...
\NormalTok{nhefs \textless{}{-}}\StringTok{ }\KeywordTok{read\_excel}\NormalTok{(}\KeywordTok{here}\NormalTok{(}\StringTok{"data"}\NormalTok{, }\StringTok{"NHEFS.xls"}\NormalTok{))}
\NormalTok{nhefs}\OperatorTok{$}\NormalTok{cens \textless{}{-}}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(}\KeywordTok{is.na}\NormalTok{(nhefs}\OperatorTok{$}\NormalTok{wt82), }\DecValTok{1}\NormalTok{, }\DecValTok{0}\NormalTok{)}

\CommentTok{\# provisionally ignore subjects with missing values for weight in 1982}
\NormalTok{nhefs.nmv \textless{}{-}}
...
\KeywordTok{lm}\NormalTok{(wt82\_}\DecValTok{71} \OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{qsmk, }\DataTypeTok{data =}\NormalTok{ nhefs.nmv)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{nhefs.nmv}\OperatorTok{$}\NormalTok{w \textless{}{-}}\StringTok{ }\DecValTok{1} \OperatorTok{/}\StringTok{ }\NormalTok{p.qsmk.obs}
...
\KeywordTok{xtabs}\NormalTok{(nhefs.nmv}\OperatorTok{$}\NormalTok{w }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{nhefs.nmv}\OperatorTok{$}\NormalTok{sex }\OperatorTok{+}\StringTok{ }\NormalTok{nhefs.nmv}\OperatorTok{$}\NormalTok{qsmk)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{nhefs.nmv}\OperatorTok{$}\NormalTok{sw \textless{}{-}}
...
\begin{Highlighting}[]
\CommentTok{\# no association between sex and qsmk in pseudo{-}population}
\KeywordTok{xtabs}\NormalTok{(nhefs.nmv}\OperatorTok{$}\NormalTok{sw }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{nhefs.nmv}\OperatorTok{$}\NormalTok{sex }\OperatorTok{+}\StringTok{ }\NormalTok{nhefs.nmv}\OperatorTok{$}\NormalTok{qsmk)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{nhefs.nmv.s \textless{}{-}}\StringTok{ }\KeywordTok{subset}\NormalTok{(nhefs.nmv, smokeintensity }\OperatorTok{\textless{}=}\StringTok{ }\DecValTok{25}\NormalTok{)}

\CommentTok{\# estimation of denominator of ip weights}
\NormalTok{den.fit.obj \textless{}{-}}\StringTok{ }\KeywordTok{lm}\NormalTok{(}
\NormalTok{  smkintensity82\_}\DecValTok{71} \OperatorTok{\textasciitilde{}}\StringTok{ }\KeywordTok{as.factor}\NormalTok{(sex) }\OperatorTok{+}
...
\NormalTok{)}
\NormalTok{p.den \textless{}{-}}\StringTok{ }\KeywordTok{predict}\NormalTok{(den.fit.obj, }\DataTypeTok{type =} \StringTok{"response"}\NormalTok{)}
\NormalTok{dens.den \textless{}{-}}
\StringTok{  }\KeywordTok{dnorm}\NormalTok{(nhefs.nmv.s}\OperatorTok{$}\NormalTok{smkintensity82\_}\DecValTok{71}\NormalTok{,}
\NormalTok{        p.den,}
        \KeywordTok{summary}\NormalTok{(den.fit.obj)}\OperatorTok{$}\NormalTok{sigma)}

\CommentTok{\# estimation of numerator of ip weights}
\NormalTok{num.fit.obj \textless{}{-}}\StringTok{ }\KeywordTok{lm}\NormalTok{(smkintensity82\_}\DecValTok{71} \OperatorTok{\textasciitilde{}}\StringTok{ }\DecValTok{1}\NormalTok{, }\DataTypeTok{data =}\NormalTok{ nhefs.nmv.s)}
\NormalTok{p.num \textless{}{-}}\StringTok{ }\KeywordTok{predict}\NormalTok{(num.fit.obj, }\DataTypeTok{type =} \StringTok{"response"}\NormalTok{)}
\NormalTok{dens.num \textless{}{-}}
\StringTok{  }\KeywordTok{dnorm}\NormalTok{(nhefs.nmv.s}\OperatorTok{$}\NormalTok{smkintensity82\_}\DecValTok{71}\NormalTok{,}
\NormalTok{        p.num,}
        \KeywordTok{summary}\NormalTok{(num.fit.obj)}\OperatorTok{$}\NormalTok{sigma)}

\NormalTok{nhefs.nmv.s}\OperatorTok{$}\NormalTok{sw.a \textless{}{-}}\StringTok{ }\NormalTok{dens.num }\OperatorTok{/}\StringTok{ }\NormalTok{dens.den}
...
\NormalTok{nhefs.nmv}\OperatorTok{$}\NormalTok{sw.a \textless{}{-}}
\StringTok{  }\KeywordTok{ifelse}\NormalTok{(nhefs.nmv}\OperatorTok{$}\NormalTok{qsmk }\OperatorTok{==}\StringTok{ }\DecValTok{0}\NormalTok{, ((}\DecValTok{1} \OperatorTok{{-}}\StringTok{ }\NormalTok{pn.qsmk) }\OperatorTok{/}\StringTok{ }\NormalTok{(}\DecValTok{1} \OperatorTok{{-}}\StringTok{ }\NormalTok{pd.qsmk)),}
\NormalTok{         (pn.qsmk }\OperatorTok{/}\StringTok{ }\NormalTok{pd.qsmk))}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pn.cens \textless{}{-}}\StringTok{ }\DecValTok{1} \OperatorTok{{-}}\StringTok{ }\KeywordTok{predict}\NormalTok{(numer.cens, }\DataTypeTok{type =} \StringTok{"response"}\NormalTok{)}

\NormalTok{nhefs}\OperatorTok{$}\NormalTok{sw.a \textless{}{-}}
...
\NormalTok{         (pn.qsmk }\OperatorTok{/}\StringTok{ }\NormalTok{pd.qsmk))}
\NormalTok{nhefs}\OperatorTok{$}\NormalTok{sw.c \textless{}{-}}\StringTok{ }\NormalTok{pn.cens }\OperatorTok{/}\StringTok{ }\NormalTok{pd.cens}
\NormalTok{nhefs}\OperatorTok{$}\NormalTok{sw \textless{}{-}}\StringTok{ }\NormalTok{nhefs}\OperatorTok{$}\NormalTok{sw.c }\OperatorTok{*}\StringTok{ }\NormalTok{nhefs}\OperatorTok{$}\NormalTok{sw.a}
...
\NormalTok{fit \textless{}{-}}
\StringTok{  }\KeywordTok{glm}\NormalTok{(}
\NormalTok{    wt82\_}\DecValTok{71} \OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{qsmk }\OperatorTok{+}\StringTok{ }\NormalTok{sex }\OperatorTok{+}\StringTok{ }\NormalTok{race }\OperatorTok{+}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }\KeywordTok{I}\NormalTok{(age }\OperatorTok{*}\StringTok{ }\NormalTok{age) }\OperatorTok{+}\StringTok{ }\KeywordTok{as.factor}\NormalTok{(education)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{nhefs}\OperatorTok{$}\NormalTok{predicted.meanY \textless{}{-}}\StringTok{ }\KeywordTok{predict}\NormalTok{(fit, nhefs)}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{summary}\NormalTok{(nhefs}\OperatorTok{$}\NormalTok{wt82\_}\DecValTok{71}\NormalTok{[nhefs}\OperatorTok{$}\NormalTok{cens }\OperatorTok{==}\StringTok{ }\DecValTok{0}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{interv \textless{}{-}}\StringTok{ }\KeywordTok{rep}\NormalTok{(}\OperatorTok{{-}}\DecValTok{1}\NormalTok{, N)}
\NormalTok{observed \textless{}{-}}\StringTok{ }\KeywordTok{cbind}\NormalTok{(L, A, Y, interv)}
\NormalTok{untreated \textless{}{-}}\StringTok{ }\KeywordTok{cbind}\NormalTok{(L, }\KeywordTok{rep}\NormalTok{(}\DecValTok{0}\NormalTok{, N), }\KeywordTok{rep}\NormalTok{(}\OtherTok{NA}\NormalTok{, N), }\KeywordTok{rep}\NormalTok{(}\DecValTok{0}\NormalTok{, N))}
\NormalTok{treated \textless{}{-}}\StringTok{ }\KeywordTok{cbind}\NormalTok{(L, }\KeywordTok{rep}\NormalTok{(}\DecValTok{1}\NormalTok{, N), }\KeywordTok{rep}\NormalTok{(}\OtherTok{NA}\NormalTok{, N), }\KeywordTok{rep}\NormalTok{(}\DecValTok{1}\NormalTok{, N))}
\NormalTok{table22 \textless{}{-}}\StringTok{ }\KeywordTok{as.data.frame}\NormalTok{(}\KeywordTok{rbind}\NormalTok{(observed, untreated, treated))}
\NormalTok{table22}\OperatorTok{$}\NormalTok{id \textless{}{-}}\StringTok{ }\KeywordTok{rep}\NormalTok{(id, }\DecValTok{3}\NormalTok{)}

\NormalTok{glm.obj \textless{}{-}}\StringTok{ }\KeywordTok{glm}\NormalTok{(Y }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{A }\OperatorTok{*}\StringTok{ }\NormalTok{L, }\DataTypeTok{data =}\NormalTok{ table22)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{table22}\OperatorTok{$}\NormalTok{predicted.meanY \textless{}{-}}\StringTok{ }\KeywordTok{predict}\NormalTok{(glm.obj, table22)}
...
\NormalTok{nhefs}\OperatorTok{$}\NormalTok{interv \textless{}{-}}\StringTok{ }\DecValTok{{-}1} \CommentTok{\# 1st copy: equal to original one}

\NormalTok{interv0 \textless{}{-}}\StringTok{ }\NormalTok{nhefs }\CommentTok{\# 2nd copy: treatment set to 0, outcome to missing}
\NormalTok{interv0}\OperatorTok{$}\NormalTok{interv \textless{}{-}}\StringTok{ }\DecValTok{0}
\NormalTok{interv0}\OperatorTok{$}\NormalTok{qsmk \textless{}{-}}\StringTok{ }\DecValTok{0}
\NormalTok{interv0}\OperatorTok{$}\NormalTok{wt82\_}\DecValTok{71}\NormalTok{ \textless{}{-}}\StringTok{ }\OtherTok{NA}

\NormalTok{interv1 \textless{}{-}}\StringTok{ }\NormalTok{nhefs }\CommentTok{\# 3rd copy: treatment set to 1, outcome to missing}
\NormalTok{interv1}\OperatorTok{$}\NormalTok{interv \textless{}{-}}\StringTok{ }\DecValTok{1}
\NormalTok{interv1}\OperatorTok{$}\NormalTok{qsmk \textless{}{-}}\StringTok{ }\DecValTok{1}
\NormalTok{interv1}\OperatorTok{$}\NormalTok{wt82\_}\DecValTok{71}\NormalTok{ \textless{}{-}}\StringTok{ }\OtherTok{NA}

\NormalTok{onesample \textless{}{-}}\StringTok{ }\KeywordTok{rbind}\NormalTok{(nhefs, interv0, interv1) }\CommentTok{\# combining datasets}
...
\NormalTok{std \textless{}{-}}\StringTok{ }\KeywordTok{glm}\NormalTok{(}
\NormalTok{  wt82\_}\DecValTok{71} \OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{qsmk }\OperatorTok{+}\StringTok{ }\NormalTok{sex }\OperatorTok{+}\StringTok{ }\NormalTok{race }\OperatorTok{+}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }\KeywordTok{I}\NormalTok{(age }\OperatorTok{*}\StringTok{ }\NormalTok{age)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{onesample}\OperatorTok{$}\NormalTok{predicted\_meanY \textless{}{-}}\StringTok{ }\KeywordTok{predict}\NormalTok{(std, onesample)}
...
\KeywordTok{mean}\NormalTok{(onesample[}\KeywordTok{which}\NormalTok{(onesample}\OperatorTok{$}\NormalTok{interv }\OperatorTok{==}\StringTok{ }\DecValTok{{-}1}\NormalTok{), ]}\OperatorTok{$}\NormalTok{predicted\_meanY)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{mean}\NormalTok{(onesample[}\KeywordTok{which}\NormalTok{(onesample}\OperatorTok{$}\NormalTok{interv }\OperatorTok{==}\StringTok{ }\DecValTok{0}\NormalTok{), ]}\OperatorTok{$}\NormalTok{predicted\_meanY)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{standardization \textless{}{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(data, indices) \{}
  \CommentTok{\# create a dataset with 3 copies of each subject}
\NormalTok{  d \textless{}{-}}\StringTok{ }\NormalTok{data[indices, ] }\CommentTok{\# 1st copy: equal to original one\textasciigrave{}}
\NormalTok{  d}\OperatorTok{$}\NormalTok{interv \textless{}{-}}\StringTok{ }\DecValTok{{-}1}
\NormalTok{  d0 \textless{}{-}}\StringTok{ }\NormalTok{d }\CommentTok{\# 2nd copy: treatment set to 0, outcome to missing}
\NormalTok{  d0}\OperatorTok{$}\NormalTok{interv \textless{}{-}}\StringTok{ }\DecValTok{0}
\NormalTok{  d0}\OperatorTok{$}\NormalTok{qsmk \textless{}{-}}\StringTok{ }\DecValTok{0}
\NormalTok{  d0}\OperatorTok{$}\NormalTok{wt82\_}\DecValTok{71}\NormalTok{ \textless{}{-}}\StringTok{ }\OtherTok{NA}
\NormalTok{  d1 \textless{}{-}}\StringTok{ }\NormalTok{d }\CommentTok{\# 3rd copy: treatment set to 1, outcome to missing}
\NormalTok{  d1}\OperatorTok{$}\NormalTok{interv \textless{}{-}}\StringTok{ }\DecValTok{1}
\NormalTok{  d1}\OperatorTok{$}\NormalTok{qsmk \textless{}{-}}\StringTok{ }\DecValTok{1}
\NormalTok{  d1}\OperatorTok{$}\NormalTok{wt82\_}\DecValTok{71}\NormalTok{ \textless{}{-}}\StringTok{ }\OtherTok{NA}
\NormalTok{  d.onesample \textless{}{-}}\StringTok{ }\KeywordTok{rbind}\NormalTok{(d, d0, d1) }\CommentTok{\# combining datasets}
...
\NormalTok{  fit \textless{}{-}}\StringTok{ }\KeywordTok{glm}\NormalTok{(}
\NormalTok{    wt82\_}\DecValTok{71} \OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{qsmk }\OperatorTok{+}\StringTok{ }\NormalTok{sex }\OperatorTok{+}\StringTok{ }\NormalTok{race }\OperatorTok{+}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }\KeywordTok{I}\NormalTok{(age }\OperatorTok{*}\StringTok{ }\NormalTok{age) }\OperatorTok{+}
\StringTok{      }\KeywordTok{as.factor}\NormalTok{(education) }\OperatorTok{+}\StringTok{ }\NormalTok{smokeintensity }\OperatorTok{+}
...
\NormalTok{  d.onesample}\OperatorTok{$}\NormalTok{predicted\_meanY \textless{}{-}}\StringTok{ }\KeywordTok{predict}\NormalTok{(fit, d.onesample)}
  ...
  \KeywordTok{return}\NormalTok{(}\KeywordTok{c}\NormalTok{(}
    \KeywordTok{mean}\NormalTok{(d.onesample}\OperatorTok{$}\NormalTok{predicted\_meanY[d.onesample}\OperatorTok{$}\NormalTok{interv }\OperatorTok{==}\StringTok{ }\DecValTok{{-}1}\NormalTok{]),}
    \KeywordTok{mean}\NormalTok{(d.onesample}\OperatorTok{$}\NormalTok{predicted\_meanY[d.onesample}\OperatorTok{$}\NormalTok{interv }\OperatorTok{==}\StringTok{ }\DecValTok{0}\NormalTok{]),}
    \KeywordTok{mean}\NormalTok{(d.onesample}\OperatorTok{$}\NormalTok{predicted\_meanY[d.onesample}\OperatorTok{$}\NormalTok{interv }\OperatorTok{==}\StringTok{ }\DecValTok{1}\NormalTok{]),}
    \KeywordTok{mean}\NormalTok{(d.onesample}\OperatorTok{$}\NormalTok{predicted\_meanY[d.onesample}\OperatorTok{$}\NormalTok{interv }\OperatorTok{==}\StringTok{ }\DecValTok{1}\NormalTok{]) }\OperatorTok{{-}}
\StringTok{      }\KeywordTok{mean}\NormalTok{(d.onesample}\OperatorTok{$}\NormalTok{predicted\_meanY[d.onesample}\OperatorTok{$}\NormalTok{interv }\OperatorTok{==}\StringTok{ }\DecValTok{0}\NormalTok{])}
\NormalTok{  ))}
\NormalTok{\}}

\CommentTok{\# bootstrap}
\NormalTok{results \textless{}{-}}\StringTok{ }\KeywordTok{boot}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ nhefs,}
...
\NormalTok{se \textless{}{-}}\StringTok{ }\KeywordTok{c}\NormalTok{(}\KeywordTok{sd}\NormalTok{(results}\OperatorTok{$}\NormalTok{t[, }\DecValTok{1}\NormalTok{]),}
...
\NormalTok{mean \textless{}{-}}\StringTok{ }\NormalTok{results}\OperatorTok{$}\NormalTok{t0}
\NormalTok{ll \textless{}{-}}\StringTok{ }\NormalTok{mean }\OperatorTok{{-}}\StringTok{ }\KeywordTok{qnorm}\NormalTok{(}\FloatTok{0.975}\NormalTok{) }\OperatorTok{*}\StringTok{ }\NormalTok{se}
\NormalTok{ul \textless{}{-}}\StringTok{ }\NormalTok{mean }\OperatorTok{+}\StringTok{ }\KeywordTok{qnorm}\NormalTok{(}\FloatTok{0.975}\NormalTok{) }\OperatorTok{*}\StringTok{ }\NormalTok{se}

\NormalTok{bootstrap \textless{}{-}}
...
\begin{verbatim}
##                         V1             mean                se               ll
## 1                 Observed 2.56188497106103 0.242256955012091 2.08707006423299
## 2             No Treatment 1.65212306626746 0.257132293783354 1.14815303118991
## 3                Treatment 5.11474489549347 0.616544303467469 3.90634026582389
## 4 Treatment - No Treatment 3.46262182922601 0.609651552373773 2.26772674345448
##                 ul
## 1 3.03669987788907
## 2 2.15609310134501
## 3 6.32314952516304
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{describe}\NormalTok{(nhefs}\OperatorTok{$}\NormalTok{wt82\_}\DecValTok{71}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{nhefs}\OperatorTok{$}\NormalTok{pd.c \textless{}{-}}\StringTok{ }\KeywordTok{predict}\NormalTok{(cw.denom, nhefs, }\DataTypeTok{type=}\StringTok{"response"}\NormalTok{)}
\NormalTok{nhefs}\OperatorTok{$}\NormalTok{wc \textless{}{-}}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(nhefs}\OperatorTok{$}\NormalTok{cens}\OperatorTok{==}\DecValTok{0}\NormalTok{, }\DecValTok{1}\OperatorTok{/}\NormalTok{nhefs}\OperatorTok{$}\NormalTok{pd.c, }\OtherTok{NA}\NormalTok{) }
...
\NormalTok{nhefs}\OperatorTok{$}\NormalTok{psi \textless{}{-}}\StringTok{ }\FloatTok{3.446}
\NormalTok{nhefs}\OperatorTok{$}\NormalTok{Hpsi \textless{}{-}}\StringTok{ }\NormalTok{nhefs}\OperatorTok{$}\NormalTok{wt82\_}\DecValTok{71} \OperatorTok{{-}}\StringTok{ }\NormalTok{nhefs}\OperatorTok{$}\NormalTok{psi}\OperatorTok{*}\NormalTok{nhefs}\OperatorTok{$}\NormalTok{qsmk}

\NormalTok{fit \textless{}{-}}\StringTok{ }\KeywordTok{geeglm}\NormalTok{(qsmk }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{sex }\OperatorTok{+}\StringTok{ }\NormalTok{race }\OperatorTok{+}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }\KeywordTok{I}\NormalTok{(age}\OperatorTok{*}\NormalTok{age) }\OperatorTok{+}\StringTok{ }\KeywordTok{as.factor}\NormalTok{(education)}
...
\begin{Highlighting}[]
\CommentTok{\#install.packages("geepack")}
\NormalTok{grid \textless{}{-}}\StringTok{ }\KeywordTok{seq}\NormalTok{(}\DataTypeTok{from =} \DecValTok{2}\NormalTok{,}\DataTypeTok{to =} \DecValTok{5}\NormalTok{, }\DataTypeTok{by =} \FloatTok{0.1}\NormalTok{)}
\NormalTok{j =}\StringTok{ }\DecValTok{0}
\NormalTok{Hpsi.coefs \textless{}{-}}\StringTok{ }\KeywordTok{cbind}\NormalTok{(}\KeywordTok{rep}\NormalTok{(}\OtherTok{NA}\NormalTok{,}\KeywordTok{length}\NormalTok{(grid)), }\KeywordTok{rep}\NormalTok{(}\OtherTok{NA}\NormalTok{, }\KeywordTok{length}\NormalTok{(grid)))}
\KeywordTok{colnames}\NormalTok{(Hpsi.coefs) \textless{}{-}}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Estimate"}\NormalTok{, }\StringTok{"p{-}value"}\NormalTok{)}
...
\NormalTok{  nhefs}\OperatorTok{$}\NormalTok{Hpsi \textless{}{-}}\StringTok{ }\NormalTok{nhefs}\OperatorTok{$}\NormalTok{wt82\_}\DecValTok{71} \OperatorTok{{-}}\StringTok{ }\NormalTok{psi }\OperatorTok{*}\StringTok{ }\NormalTok{nhefs}\OperatorTok{$}\NormalTok{qsmk }
  
\NormalTok{  gest.fit \textless{}{-}}\StringTok{ }\KeywordTok{geeglm}\NormalTok{(qsmk }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{sex }\OperatorTok{+}\StringTok{ }\NormalTok{race }\OperatorTok{+}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }\KeywordTok{I}\NormalTok{(age}\OperatorTok{*}\NormalTok{age) }\OperatorTok{+}\StringTok{ }\KeywordTok{as.factor}\NormalTok{(education)}
                  \OperatorTok{+}\StringTok{ }\NormalTok{smokeintensity }\OperatorTok{+}\StringTok{ }\KeywordTok{I}\NormalTok{(smokeintensity}\OperatorTok{*}\NormalTok{smokeintensity) }\OperatorTok{+}\StringTok{ }\NormalTok{smokeyrs}
                  \OperatorTok{+}\StringTok{ }\KeywordTok{I}\NormalTok{(smokeyrs}\OperatorTok{*}\NormalTok{smokeyrs) }\OperatorTok{+}\StringTok{ }\KeywordTok{as.factor}\NormalTok{(exercise) }\OperatorTok{+}\StringTok{ }\KeywordTok{as.factor}\NormalTok{(active)}
                  \OperatorTok{+}\StringTok{ }\NormalTok{wt71 }\OperatorTok{+}\StringTok{ }\KeywordTok{I}\NormalTok{(wt71}\OperatorTok{*}\NormalTok{wt71) }\OperatorTok{+}\StringTok{ }\NormalTok{Hpsi, }\DataTypeTok{family=}\NormalTok{binomial, }\DataTypeTok{data=}\NormalTok{nhefs,}
                  \DataTypeTok{weights=}\NormalTok{wc, }\DataTypeTok{id=}\NormalTok{seqn, }\DataTypeTok{corstr=}\StringTok{"independence"}\NormalTok{)}
\NormalTok{  Hpsi.coefs[j,}\DecValTok{1}\NormalTok{] \textless{}{-}}\StringTok{ }\KeywordTok{summary}\NormalTok{(gest.fit)}\OperatorTok{$}\NormalTok{coefficients[}\StringTok{"Hpsi"}\NormalTok{, }\StringTok{"Estimate"}\NormalTok{]}
\NormalTok{  Hpsi.coefs[j,}\DecValTok{2}\NormalTok{] \textless{}{-}}\StringTok{ }\KeywordTok{summary}\NormalTok{(gest.fit)}\OperatorTok{$}\NormalTok{coefficients[}\StringTok{"Hpsi"}\NormalTok{, }\StringTok{"Pr(\textgreater{}|W|)"}\NormalTok{]}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{nhefs}\OperatorTok{$}\NormalTok{pqsmk \textless{}{-}}\StringTok{ }\KeywordTok{predict}\NormalTok{(logit.est, nhefs, }\DataTypeTok{type =} \StringTok{"response"}\NormalTok{)}
...
\NormalTok{nhefs.c \textless{}{-}}\StringTok{ }\NormalTok{nhefs[}\KeywordTok{which}\NormalTok{(}\OperatorTok{!}\KeywordTok{is.na}\NormalTok{(nhefs}\OperatorTok{$}\NormalTok{wt82)),]}
\KeywordTok{with}\NormalTok{(nhefs.c, }\KeywordTok{sum}\NormalTok{(wc}\OperatorTok{*}\NormalTok{wt82\_}\DecValTok{71}\OperatorTok{*}\NormalTok{(qsmk}\OperatorTok{{-}}\NormalTok{pqsmk)) }\OperatorTok{/}\StringTok{ }\KeywordTok{sum}\NormalTok{(wc}\OperatorTok{*}\NormalTok{qsmk}\OperatorTok{*}\NormalTok{(qsmk }\OperatorTok{{-}}\StringTok{ }\NormalTok{pqsmk)))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{fit \textless{}{-}}\StringTok{ }\KeywordTok{glm}\NormalTok{(wt82\_}\DecValTok{71} \OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{qsmk }\OperatorTok{+}\StringTok{ }\NormalTok{sex }\OperatorTok{+}\StringTok{ }\NormalTok{race }\OperatorTok{+}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }\KeywordTok{I}\NormalTok{(age}\OperatorTok{*}\NormalTok{age) }\OperatorTok{+}\StringTok{ }\KeywordTok{as.factor}\NormalTok{(education)}
           \OperatorTok{+}\StringTok{ }\NormalTok{smokeintensity }\OperatorTok{+}\StringTok{ }\KeywordTok{I}\NormalTok{(smokeintensity}\OperatorTok{*}\NormalTok{smokeintensity) }\OperatorTok{+}\StringTok{ }\NormalTok{smokeyrs}
           \OperatorTok{+}\StringTok{ }\KeywordTok{I}\NormalTok{(smokeyrs}\OperatorTok{*}\NormalTok{smokeyrs) }\OperatorTok{+}\StringTok{ }\KeywordTok{as.factor}\NormalTok{(exercise) }\OperatorTok{+}\StringTok{ }\KeywordTok{as.factor}\NormalTok{(active)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{nhefs}\OperatorTok{$}\NormalTok{ps \textless{}{-}}\StringTok{ }\KeywordTok{predict}\NormalTok{(fit3, nhefs, }\DataTypeTok{type=}\StringTok{"response"}\NormalTok{)}
...
\NormalTok{nhefs}\OperatorTok{$}\NormalTok{ps.dec \textless{}{-}}\StringTok{ }\KeywordTok{cut}\NormalTok{(nhefs}\OperatorTok{$}\NormalTok{ps, }
...
\NormalTok{decile \textless{}{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(x) \{}
...
\ControlFlowTok{for}\NormalTok{ (deciles }\ControlFlowTok{in} \KeywordTok{c}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\DecValTok{10}\NormalTok{)) \{}
  \KeywordTok{print}\NormalTok{(}\KeywordTok{t.test}\NormalTok{(wt82\_}\DecValTok{71}\OperatorTok{\textasciitilde{}}\NormalTok{qsmk, }\DataTypeTok{data=}\NormalTok{nhefs[}\KeywordTok{which}\NormalTok{(nhefs}\OperatorTok{$}\NormalTok{ps.dec}\OperatorTok{==}\NormalTok{deciles),]))}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{std.ps \textless{}{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(data, indices) \{}
\NormalTok{  d \textless{}{-}}\StringTok{ }\NormalTok{data[indices,] }\CommentTok{\# 1st copy: equal to original one\textasciigrave{}}
  \CommentTok{\# calculating propensity scores}
\NormalTok{  ps.fit \textless{}{-}}\StringTok{ }\KeywordTok{glm}\NormalTok{(qsmk }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{sex }\OperatorTok{+}\StringTok{ }\NormalTok{race }\OperatorTok{+}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }\KeywordTok{I}\NormalTok{(age}\OperatorTok{*}\NormalTok{age) }
                \OperatorTok{+}\StringTok{ }\KeywordTok{as.factor}\NormalTok{(education) }\OperatorTok{+}\StringTok{ }\NormalTok{smokeintensity}
...
\NormalTok{  d}\OperatorTok{$}\NormalTok{pscore \textless{}{-}}\StringTok{ }\KeywordTok{predict}\NormalTok{(ps.fit, d, }\DataTypeTok{type=}\StringTok{"response"}\NormalTok{)}
  
  \CommentTok{\# create a dataset with 3 copies of each subject}
\NormalTok{  d}\OperatorTok{$}\NormalTok{interv \textless{}{-}}\StringTok{ }\DecValTok{{-}1} \CommentTok{\# 1st copy: equal to original one\textasciigrave{}}
\NormalTok{  d0 \textless{}{-}}\StringTok{ }\NormalTok{d }\CommentTok{\# 2nd copy: treatment set to 0, outcome to missing}
\NormalTok{  d0}\OperatorTok{$}\NormalTok{interv \textless{}{-}}\StringTok{ }\DecValTok{0}
\NormalTok{  d0}\OperatorTok{$}\NormalTok{qsmk \textless{}{-}}\StringTok{ }\DecValTok{0}
\NormalTok{  d0}\OperatorTok{$}\NormalTok{wt82\_}\DecValTok{71}\NormalTok{ \textless{}{-}}\StringTok{ }\OtherTok{NA}
...
\NormalTok{  std.fit \textless{}{-}}\StringTok{ }\KeywordTok{glm}\NormalTok{(wt82\_}\DecValTok{71} \OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{qsmk }\OperatorTok{+}\StringTok{ }\NormalTok{pscore }\OperatorTok{+}\StringTok{ }\KeywordTok{I}\NormalTok{(qsmk}\OperatorTok{*}\NormalTok{pscore), }\DataTypeTok{data=}\NormalTok{d.onesample)}
\NormalTok{  d.onesample}\OperatorTok{$}\NormalTok{predicted\_meanY \textless{}{-}}\StringTok{ }\KeywordTok{predict}\NormalTok{(std.fit, d.onesample)}

  \CommentTok{\# estimate mean outcome in each of the groups interv={-}1, interv=0, and interv=1}
  \KeywordTok{return}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\KeywordTok{mean}\NormalTok{(d.onesample}\OperatorTok{$}\NormalTok{predicted\_meanY[d.onesample}\OperatorTok{$}\NormalTok{interv}\OperatorTok{=={-}}\DecValTok{1}\NormalTok{]),}
           \KeywordTok{mean}\NormalTok{(d.onesample}\OperatorTok{$}\NormalTok{predicted\_meanY[d.onesample}\OperatorTok{$}\NormalTok{interv}\OperatorTok{==}\DecValTok{0}\NormalTok{]),}
           \KeywordTok{mean}\NormalTok{(d.onesample}\OperatorTok{$}\NormalTok{predicted\_meanY[d.onesample}\OperatorTok{$}\NormalTok{interv}\OperatorTok{==}\DecValTok{1}\NormalTok{]),}
           \KeywordTok{mean}\NormalTok{(d.onesample}\OperatorTok{$}\NormalTok{predicted\_meanY[d.onesample}\OperatorTok{$}\NormalTok{interv}\OperatorTok{==}\DecValTok{1}\NormalTok{])}\OperatorTok{{-}}
\StringTok{             }\KeywordTok{mean}\NormalTok{(d.onesample}\OperatorTok{$}\NormalTok{predicted\_meanY[d.onesample}\OperatorTok{$}\NormalTok{interv}\OperatorTok{==}\DecValTok{0}\NormalTok{])))}
\NormalTok{\}}

\CommentTok{\# bootstrap}
\NormalTok{results \textless{}{-}}\StringTok{ }\KeywordTok{boot}\NormalTok{(}\DataTypeTok{data=}\NormalTok{nhefs, }\DataTypeTok{statistic=}\NormalTok{std.ps, }\DataTypeTok{R=}\DecValTok{5}\NormalTok{)}

\CommentTok{\# generating confidence intervals}
\NormalTok{se \textless{}{-}}\StringTok{ }\KeywordTok{c}\NormalTok{(}\KeywordTok{sd}\NormalTok{(results}\OperatorTok{$}\NormalTok{t[,}\DecValTok{1}\NormalTok{]), }\KeywordTok{sd}\NormalTok{(results}\OperatorTok{$}\NormalTok{t[,}\DecValTok{2}\NormalTok{]), }
...
\NormalTok{mean \textless{}{-}}\StringTok{ }\NormalTok{results}\OperatorTok{$}\NormalTok{t0}
\NormalTok{ll \textless{}{-}}\StringTok{ }\NormalTok{mean }\OperatorTok{{-}}\StringTok{ }\KeywordTok{qnorm}\NormalTok{(}\FloatTok{0.975}\NormalTok{)}\OperatorTok{*}\NormalTok{se}
\NormalTok{ul \textless{}{-}}\StringTok{ }\NormalTok{mean }\OperatorTok{+}\StringTok{ }\KeywordTok{qnorm}\NormalTok{(}\FloatTok{0.975}\NormalTok{)}\OperatorTok{*}\NormalTok{se}
...
\begin{verbatim}
##                         V1             mean                se               ll
## 1                 Observed 2.63384609228479  0.23104378006893  2.1810086044977
## 2             No Treatment 1.71983636149843 0.280285990716815 1.17048591432234
## 3                Treatment 5.35072300362993 0.554835367114129 4.26326566673718
## 4 Treatment - No Treatment 3.63088664213151 0.420597387030803 2.80653091155948
##                 ul
## 1 3.08668358007189
## 2 2.26918680867451
## 3 6.43818034052268
...
\NormalTok{treated \textless{}{-}}\StringTok{ }\NormalTok{nhefs}
\NormalTok{  treated}\OperatorTok{$}\NormalTok{qsmk \textless{}{-}}\StringTok{ }\DecValTok{1}

\NormalTok{untreated \textless{}{-}}\StringTok{ }\NormalTok{nhefs}
\NormalTok{  untreated}\OperatorTok{$}\NormalTok{qsmk \textless{}{-}}\StringTok{ }\DecValTok{0}

\CommentTok{\# (step 2) predict values for everyone in each new dataset based on above model}
\NormalTok{treated}\OperatorTok{$}\NormalTok{pred.y \textless{}{-}}\StringTok{ }\KeywordTok{predict}\NormalTok{(model6, treated)}
\NormalTok{untreated}\OperatorTok{$}\NormalTok{pred.y \textless{}{-}}\StringTok{ }\KeywordTok{predict}\NormalTok{(model6, untreated)}

\CommentTok{\# (step 3) compare mean weight loss had all been treated vs. that had all been untreated}
\NormalTok{mean1 \textless{}{-}}\StringTok{ }\KeywordTok{mean}\NormalTok{(treated}\OperatorTok{$}\NormalTok{pred.y, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)}
\NormalTok{mean0 \textless{}{-}}\StringTok{ }\KeywordTok{mean}\NormalTok{(untreated}\OperatorTok{$}\NormalTok{pred.y, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)}
\NormalTok{mean1}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{nboot \textless{}{-}}\StringTok{ }\DecValTok{100}
\CommentTok{\# set up a matrix to store results}
\NormalTok{boots \textless{}{-}}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{i =} \DecValTok{1}\OperatorTok{:}\NormalTok{nboot,}
...
\NormalTok{nhefs \textless{}{-}}\StringTok{ }\KeywordTok{subset}\NormalTok{(nhefs, }\OperatorTok{!}\KeywordTok{is.na}\NormalTok{(ps) }\OperatorTok{\&}\StringTok{ }\OperatorTok{!}\KeywordTok{is.na}\NormalTok{(wt82\_}\DecValTok{71}\NormalTok{)) }\CommentTok{\# p.qsmk}
...
\NormalTok{  sampl \textless{}{-}}\StringTok{ }\NormalTok{nhefs[}\KeywordTok{sample}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\KeywordTok{nrow}\NormalTok{(nhefs), }\KeywordTok{nrow}\NormalTok{(nhefs), }\DataTypeTok{replace =} \OtherTok{TRUE}\NormalTok{), ]}
  
  \CommentTok{\# fit the model in the bootstrap sample}
\NormalTok{  bootmod \textless{}{-}}\StringTok{ }\KeywordTok{glm}\NormalTok{(wt82\_}\DecValTok{71} \OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{qsmk }\OperatorTok{+}\StringTok{ }\NormalTok{ps, }\DataTypeTok{data =}\NormalTok{ sampl) }\CommentTok{\# ps}
  
  \CommentTok{\# create new datasets}
\NormalTok{  sampl.treated \textless{}{-}}\StringTok{ }\NormalTok{sampl }\OperatorTok{\%\textgreater{}\%}
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{qsmk =} \DecValTok{1}\NormalTok{)}
  
\NormalTok{  sampl.untreated \textless{}{-}}\StringTok{ }\NormalTok{sampl }\OperatorTok{\%\textgreater{}\%}
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{qsmk =} \DecValTok{0}\NormalTok{)}
  
  \CommentTok{\# predict values}
\NormalTok{  sampl.treated}\OperatorTok{$}\NormalTok{pred.y \textless{}{-}}\StringTok{ }\KeywordTok{predict}\NormalTok{(bootmod, sampl.treated)}
\NormalTok{  sampl.untreated}\OperatorTok{$}\NormalTok{pred.y \textless{}{-}}\StringTok{ }\KeywordTok{predict}\NormalTok{(bootmod, sampl.untreated)}
  
  \CommentTok{\# output results }
\NormalTok{  boots[i, }\StringTok{\textquotesingle{}mean1\textquotesingle{}}\NormalTok{] \textless{}{-}}\StringTok{ }\KeywordTok{mean}\NormalTok{(sampl.treated}\OperatorTok{$}\NormalTok{pred.y, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)}
\NormalTok{  boots[i, }\StringTok{\textquotesingle{}mean0\textquotesingle{}}\NormalTok{] \textless{}{-}}\StringTok{ }\KeywordTok{mean}\NormalTok{(sampl.untreated}\OperatorTok{$}\NormalTok{pred.y, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)}
\NormalTok{  boots[i, }\StringTok{\textquotesingle{}difference\textquotesingle{}}\NormalTok{] \textless{}{-}}\StringTok{ }\NormalTok{boots[i, }\StringTok{\textquotesingle{}mean1\textquotesingle{}}\NormalTok{] }\OperatorTok{{-}}\StringTok{ }\NormalTok{boots[i, }\StringTok{\textquotesingle{}mean0\textquotesingle{}}\NormalTok{]}
  
  \CommentTok{\# once loop is done, print the results}
  \ControlFlowTok{if}\NormalTok{(i }\OperatorTok{==}\StringTok{ }\NormalTok{nboot) \{}
    \KeywordTok{cat}\NormalTok{(}\StringTok{\textquotesingle{}95\% CI for the causal mean difference}\CharTok{\textbackslash{}n}\StringTok{\textquotesingle{}}\NormalTok{)}
...
\NormalTok{nhefs.iv \textless{}{-}}\StringTok{ }\NormalTok{nhefs[}\KeywordTok{which}\NormalTok{(}\OperatorTok{!}\KeywordTok{is.na}\NormalTok{(nhefs}\OperatorTok{$}\NormalTok{wt82) }\OperatorTok{\&}\StringTok{ }\OperatorTok{!}\KeywordTok{is.na}\NormalTok{(nhefs}\OperatorTok{$}\NormalTok{price82)),]}
\NormalTok{nhefs.iv}\OperatorTok{$}\NormalTok{highprice \textless{}{-}}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(nhefs.iv}\OperatorTok{$}\NormalTok{price82}\OperatorTok{\textgreater{}=}\FloatTok{1.5}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{0}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{nhefs.iv}\OperatorTok{$}\NormalTok{psi \textless{}{-}}\StringTok{ }\FloatTok{2.396}
\NormalTok{nhefs.iv}\OperatorTok{$}\NormalTok{Hpsi \textless{}{-}}\StringTok{ }\NormalTok{nhefs.iv}\OperatorTok{$}\NormalTok{wt82\_}\DecValTok{71}\OperatorTok{{-}}\NormalTok{nhefs.iv}\OperatorTok{$}\NormalTok{psi}\OperatorTok{*}\NormalTok{nhefs.iv}\OperatorTok{$}\NormalTok{qsmk}

\CommentTok{\#install.packages("geepack") \# install package if required}
\KeywordTok{library}\NormalTok{(}\StringTok{"geepack"}\NormalTok{)}
\NormalTok{g.est \textless{}{-}}\StringTok{ }\KeywordTok{geeglm}\NormalTok{(highprice }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{Hpsi, }\DataTypeTok{data=}\NormalTok{nhefs.iv, }\DataTypeTok{id=}\NormalTok{seqn, }\DataTypeTok{family=}\KeywordTok{binomial}\NormalTok{(),}
...
\CommentTok{\# some preprocessing of the data }
\NormalTok{nhefs}\OperatorTok{$}\NormalTok{survtime \textless{}{-}}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(nhefs}\OperatorTok{$}\NormalTok{death}\OperatorTok{==}\DecValTok{0}\NormalTok{, }\DecValTok{120}\NormalTok{, }
...
\NormalTok{nhefs.surv \textless{}{-}}\StringTok{ }\KeywordTok{expandRows}\NormalTok{(nhefs, }\StringTok{"survtime"}\NormalTok{, }\DataTypeTok{drop=}\NormalTok{F) }
\NormalTok{nhefs.surv}\OperatorTok{$}\NormalTok{time \textless{}{-}}\StringTok{ }\KeywordTok{sequence}\NormalTok{(}\KeywordTok{rle}\NormalTok{(nhefs.surv}\OperatorTok{$}\NormalTok{seqn)}\OperatorTok{$}\NormalTok{lengths)}\OperatorTok{{-}}\DecValTok{1}
\NormalTok{nhefs.surv}\OperatorTok{$}\NormalTok{event \textless{}{-}}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(nhefs.surv}\OperatorTok{$}\NormalTok{time}\OperatorTok{==}\NormalTok{nhefs.surv}\OperatorTok{$}\NormalTok{survtime}\DecValTok{{-}1} \OperatorTok{\&}\StringTok{ }
...
\NormalTok{nhefs.surv}\OperatorTok{$}\NormalTok{timesq \textless{}{-}}\StringTok{ }\NormalTok{nhefs.surv}\OperatorTok{$}\NormalTok{time}\OperatorTok{\^{}}\DecValTok{2}

\CommentTok{\# fit of parametric hazards model}
\NormalTok{hazards.model \textless{}{-}}\StringTok{ }\KeywordTok{glm}\NormalTok{(event}\OperatorTok{==}\DecValTok{0} \OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{qsmk }\OperatorTok{+}\StringTok{ }\KeywordTok{I}\NormalTok{(qsmk}\OperatorTok{*}\NormalTok{time) }\OperatorTok{+}\StringTok{ }\KeywordTok{I}\NormalTok{(qsmk}\OperatorTok{*}\NormalTok{timesq) }\OperatorTok{+}\StringTok{ }
...
\NormalTok{qsmk0 \textless{}{-}}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\KeywordTok{cbind}\NormalTok{(}\KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{119}\NormalTok{),}\DecValTok{0}\NormalTok{,(}\KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{119}\NormalTok{))}\OperatorTok{\^{}}\DecValTok{2}\NormalTok{))}
\NormalTok{qsmk1 \textless{}{-}}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\KeywordTok{cbind}\NormalTok{(}\KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{119}\NormalTok{),}\DecValTok{1}\NormalTok{,(}\KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{119}\NormalTok{))}\OperatorTok{\^{}}\DecValTok{2}\NormalTok{))}

\KeywordTok{colnames}\NormalTok{(qsmk0) \textless{}{-}}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"time"}\NormalTok{, }\StringTok{"qsmk"}\NormalTok{, }\StringTok{"timesq"}\NormalTok{)}
\KeywordTok{colnames}\NormalTok{(qsmk1) \textless{}{-}}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"time"}\NormalTok{, }\StringTok{"qsmk"}\NormalTok{, }\StringTok{"timesq"}\NormalTok{)}

\CommentTok{\# assignment of estimated (1{-}hazard) to each person{-}month */}
\NormalTok{qsmk0}\OperatorTok{$}\NormalTok{p.noevent0 \textless{}{-}}\StringTok{ }\KeywordTok{predict}\NormalTok{(hazards.model, qsmk0, }\DataTypeTok{type=}\StringTok{"response"}\NormalTok{)}
\NormalTok{qsmk1}\OperatorTok{$}\NormalTok{p.noevent1 \textless{}{-}}\StringTok{ }\KeywordTok{predict}\NormalTok{(hazards.model, qsmk1, }\DataTypeTok{type=}\StringTok{"response"}\NormalTok{)}

\CommentTok{\# computation of survival for each person{-}month}
\NormalTok{qsmk0}\OperatorTok{$}\NormalTok{surv0 \textless{}{-}}\StringTok{ }\KeywordTok{cumprod}\NormalTok{(qsmk0}\OperatorTok{$}\NormalTok{p.noevent0)}
\NormalTok{qsmk1}\OperatorTok{$}\NormalTok{surv1 \textless{}{-}}\StringTok{ }\KeywordTok{cumprod}\NormalTok{(qsmk1}\OperatorTok{$}\NormalTok{p.noevent1)}

\CommentTok{\# some data management to plot estimated survival curves}
\NormalTok{hazards.graph \textless{}{-}}\StringTok{ }\KeywordTok{merge}\NormalTok{(qsmk0, qsmk1, }\DataTypeTok{by=}\KeywordTok{c}\NormalTok{(}\StringTok{"time"}\NormalTok{, }\StringTok{"timesq"}\NormalTok{))}
\NormalTok{hazards.graph}\OperatorTok{$}\NormalTok{survdiff \textless{}{-}}\StringTok{ }\NormalTok{hazards.graph}\OperatorTok{$}\NormalTok{surv1}\OperatorTok{{-}}\NormalTok{hazards.graph}\OperatorTok{$}\NormalTok{surv0}
...
\begin{Highlighting}[]
\CommentTok{\# estimation of denominator of ip weights}
\NormalTok{p.denom \textless{}{-}}\StringTok{ }\KeywordTok{glm}\NormalTok{(qsmk }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{sex }\OperatorTok{+}\StringTok{ }\NormalTok{race }\OperatorTok{+}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }\KeywordTok{I}\NormalTok{(age}\OperatorTok{*}\NormalTok{age) }\OperatorTok{+}\StringTok{ }\KeywordTok{as.factor}\NormalTok{(education)}
...
\NormalTok{nhefs}\OperatorTok{$}\NormalTok{pd.qsmk \textless{}{-}}\StringTok{ }\KeywordTok{predict}\NormalTok{(p.denom, nhefs, }\DataTypeTok{type=}\StringTok{"response"}\NormalTok{)}

\CommentTok{\# estimation of numerator of ip weights}
\NormalTok{p.num \textless{}{-}}\StringTok{ }\KeywordTok{glm}\NormalTok{(qsmk }\OperatorTok{\textasciitilde{}}\StringTok{ }\DecValTok{1}\NormalTok{, }\DataTypeTok{data=}\NormalTok{nhefs, }\DataTypeTok{family=}\KeywordTok{binomial}\NormalTok{())}
\NormalTok{nhefs}\OperatorTok{$}\NormalTok{pn.qsmk \textless{}{-}}\StringTok{ }\KeywordTok{predict}\NormalTok{(p.num, nhefs, }\DataTypeTok{type=}\StringTok{"response"}\NormalTok{)}

\CommentTok{\# computation of estimated weights}
\NormalTok{nhefs}\OperatorTok{$}\NormalTok{sw.a \textless{}{-}}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(nhefs}\OperatorTok{$}\NormalTok{qsmk}\OperatorTok{==}\DecValTok{1}\NormalTok{, nhefs}\OperatorTok{$}\NormalTok{pn.qsmk}\OperatorTok{/}\NormalTok{nhefs}\OperatorTok{$}\NormalTok{pd.qsmk,}
...
\begin{Highlighting}[]
\CommentTok{\# creation of person{-}month data}
\NormalTok{nhefs.ipw \textless{}{-}}\StringTok{ }\KeywordTok{expandRows}\NormalTok{(nhefs, }\StringTok{"survtime"}\NormalTok{, }\DataTypeTok{drop=}\NormalTok{F) }
\NormalTok{nhefs.ipw}\OperatorTok{$}\NormalTok{time \textless{}{-}}\StringTok{ }\KeywordTok{sequence}\NormalTok{(}\KeywordTok{rle}\NormalTok{(nhefs.ipw}\OperatorTok{$}\NormalTok{seqn)}\OperatorTok{$}\NormalTok{lengths)}\OperatorTok{{-}}\DecValTok{1}
\NormalTok{nhefs.ipw}\OperatorTok{$}\NormalTok{event \textless{}{-}}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(nhefs.ipw}\OperatorTok{$}\NormalTok{time}\OperatorTok{==}\NormalTok{nhefs.ipw}\OperatorTok{$}\NormalTok{survtime}\DecValTok{{-}1} \OperatorTok{\&}\StringTok{ }
...
\NormalTok{nhefs.ipw}\OperatorTok{$}\NormalTok{timesq \textless{}{-}}\StringTok{ }\NormalTok{nhefs.ipw}\OperatorTok{$}\NormalTok{time}\OperatorTok{\^{}}\DecValTok{2}

\CommentTok{\# fit of weighted hazards model}
\NormalTok{ipw.model \textless{}{-}}\StringTok{ }\KeywordTok{glm}\NormalTok{(event}\OperatorTok{==}\DecValTok{0} \OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{qsmk }\OperatorTok{+}\StringTok{ }\KeywordTok{I}\NormalTok{(qsmk}\OperatorTok{*}\NormalTok{time) }\OperatorTok{+}\StringTok{ }\KeywordTok{I}\NormalTok{(qsmk}\OperatorTok{*}\NormalTok{timesq) }\OperatorTok{+}\StringTok{ }
...
\NormalTok{ipw.qsmk0 \textless{}{-}}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\KeywordTok{cbind}\NormalTok{(}\KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{119}\NormalTok{),}\DecValTok{0}\NormalTok{,(}\KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{119}\NormalTok{))}\OperatorTok{\^{}}\DecValTok{2}\NormalTok{))}
\NormalTok{ipw.qsmk1 \textless{}{-}}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\KeywordTok{cbind}\NormalTok{(}\KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{119}\NormalTok{),}\DecValTok{1}\NormalTok{,(}\KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{119}\NormalTok{))}\OperatorTok{\^{}}\DecValTok{2}\NormalTok{))}

\KeywordTok{colnames}\NormalTok{(ipw.qsmk0) \textless{}{-}}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"time"}\NormalTok{, }\StringTok{"qsmk"}\NormalTok{, }\StringTok{"timesq"}\NormalTok{)}
\KeywordTok{colnames}\NormalTok{(ipw.qsmk1) \textless{}{-}}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"time"}\NormalTok{, }\StringTok{"qsmk"}\NormalTok{, }\StringTok{"timesq"}\NormalTok{)}

\CommentTok{\# assignment of estimated (1{-}hazard) to each person{-}month */}
\NormalTok{ipw.qsmk0}\OperatorTok{$}\NormalTok{p.noevent0 \textless{}{-}}\StringTok{ }\KeywordTok{predict}\NormalTok{(ipw.model, ipw.qsmk0, }\DataTypeTok{type=}\StringTok{"response"}\NormalTok{)}
\NormalTok{ipw.qsmk1}\OperatorTok{$}\NormalTok{p.noevent1 \textless{}{-}}\StringTok{ }\KeywordTok{predict}\NormalTok{(ipw.model, ipw.qsmk1, }\DataTypeTok{type=}\StringTok{"response"}\NormalTok{)}

\CommentTok{\# computation of survival for each person{-}month}
\NormalTok{ipw.qsmk0}\OperatorTok{$}\NormalTok{surv0 \textless{}{-}}\StringTok{ }\KeywordTok{cumprod}\NormalTok{(ipw.qsmk0}\OperatorTok{$}\NormalTok{p.noevent0)}
\NormalTok{ipw.qsmk1}\OperatorTok{$}\NormalTok{surv1 \textless{}{-}}\StringTok{ }\KeywordTok{cumprod}\NormalTok{(ipw.qsmk1}\OperatorTok{$}\NormalTok{p.noevent1)}

\CommentTok{\# some data management to plot estimated survival curves}
\NormalTok{ipw.graph \textless{}{-}}\StringTok{ }\KeywordTok{merge}\NormalTok{(ipw.qsmk0, ipw.qsmk1, }\DataTypeTok{by=}\KeywordTok{c}\NormalTok{(}\StringTok{"time"}\NormalTok{, }\StringTok{"timesq"}\NormalTok{))}
\NormalTok{ipw.graph}\OperatorTok{$}\NormalTok{survdiff \textless{}{-}}\StringTok{ }\NormalTok{ipw.graph}\OperatorTok{$}\NormalTok{surv1}\OperatorTok{{-}}\NormalTok{ipw.graph}\OperatorTok{$}\NormalTok{surv0}
...
\NormalTok{gf.qsmk0 \textless{}{-}}\StringTok{ }\KeywordTok{expandRows}\NormalTok{(nhefs, }\DataTypeTok{count=}\DecValTok{120}\NormalTok{, }\DataTypeTok{count.is.col=}\NormalTok{F) }
\NormalTok{gf.qsmk0}\OperatorTok{$}\NormalTok{time \textless{}{-}}\StringTok{ }\KeywordTok{rep}\NormalTok{(}\KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{119}\NormalTok{), }\KeywordTok{nrow}\NormalTok{(nhefs))}
\NormalTok{gf.qsmk0}\OperatorTok{$}\NormalTok{timesq \textless{}{-}}\StringTok{ }\NormalTok{gf.qsmk0}\OperatorTok{$}\NormalTok{time}\OperatorTok{\^{}}\DecValTok{2}
\NormalTok{gf.qsmk0}\OperatorTok{$}\NormalTok{qsmk \textless{}{-}}\StringTok{ }\DecValTok{0}

\NormalTok{gf.qsmk1 \textless{}{-}}\StringTok{ }\NormalTok{gf.qsmk0}
\NormalTok{gf.qsmk1}\OperatorTok{$}\NormalTok{qsmk \textless{}{-}}\StringTok{ }\DecValTok{1}

\NormalTok{gf.qsmk0}\OperatorTok{$}\NormalTok{p.noevent0 \textless{}{-}}\StringTok{ }\KeywordTok{predict}\NormalTok{(gf.model, gf.qsmk0, }\DataTypeTok{type=}\StringTok{"response"}\NormalTok{)}
\NormalTok{gf.qsmk1}\OperatorTok{$}\NormalTok{p.noevent1 \textless{}{-}}\StringTok{ }\KeywordTok{predict}\NormalTok{(gf.model, gf.qsmk1, }\DataTypeTok{type=}\StringTok{"response"}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{gf.qsmk0.surv \textless{}{-}}\StringTok{ }\NormalTok{gf.qsmk0 }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\KeywordTok{group\_by}\NormalTok{(seqn) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{surv0 =} \KeywordTok{cumprod}\NormalTok{(p.noevent0))}
\NormalTok{gf.qsmk1.surv \textless{}{-}}\StringTok{ }\NormalTok{gf.qsmk1 }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\KeywordTok{group\_by}\NormalTok{(seqn) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{surv1 =} \KeywordTok{cumprod}\NormalTok{(p.noevent1))}

\NormalTok{gf.surv0 \textless{}{-}}\StringTok{ }\KeywordTok{aggregate}\NormalTok{(gf.qsmk0.surv, }\DataTypeTok{by=}\KeywordTok{list}\NormalTok{(gf.qsmk0.surv}\OperatorTok{$}\NormalTok{time), }\DataTypeTok{FUN=}\NormalTok{mean)[}\KeywordTok{c}\NormalTok{(}\StringTok{"qsmk"}\NormalTok{, }\StringTok{"time"}\NormalTok{, }\StringTok{"surv0"}\NormalTok{)]}
\NormalTok{gf.surv1 \textless{}{-}}\StringTok{ }\KeywordTok{aggregate}\NormalTok{(gf.qsmk1.surv, }\DataTypeTok{by=}\KeywordTok{list}\NormalTok{(gf.qsmk1.surv}\OperatorTok{$}\NormalTok{time), }\DataTypeTok{FUN=}\NormalTok{mean)[}\KeywordTok{c}\NormalTok{(}\StringTok{"qsmk"}\NormalTok{, }\StringTok{"time"}\NormalTok{, }\StringTok{"surv1"}\NormalTok{)]}

\NormalTok{gf.graph \textless{}{-}}\StringTok{ }\KeywordTok{merge}\NormalTok{(gf.surv0, gf.surv1, }\DataTypeTok{by=}\KeywordTok{c}\NormalTok{(}\StringTok{"time"}\NormalTok{))}
\NormalTok{gf.graph}\OperatorTok{$}\NormalTok{survdiff \textless{}{-}}\StringTok{ }\NormalTok{gf.graph}\OperatorTok{$}\NormalTok{surv1}\OperatorTok{{-}}\NormalTok{gf.graph}\OperatorTok{$}\NormalTok{surv0}
...
\CommentTok{\# some preprocessing of the data}
\NormalTok{nhefs \textless{}{-}}\StringTok{ }\KeywordTok{read\_excel}\NormalTok{(}\KeywordTok{here}\NormalTok{(}\StringTok{"data"}\NormalTok{, }\StringTok{"NHEFS.xls"}\NormalTok{))}
\NormalTok{nhefs}\OperatorTok{$}\NormalTok{survtime \textless{}{-}}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(nhefs}\OperatorTok{$}\NormalTok{death}\OperatorTok{==}\DecValTok{0}\NormalTok{, }\OtherTok{NA}\NormalTok{, (nhefs}\OperatorTok{$}\NormalTok{yrdth}\DecValTok{{-}83}\NormalTok{)}\OperatorTok{*}\DecValTok{12}\OperatorTok{+}\NormalTok{nhefs}\OperatorTok{$}\NormalTok{modth) }\CommentTok{\# * yrdth ranges from 83 to 92}

\CommentTok{\# model to estimate E[A|L]}
\NormalTok{modelA \textless{}{-}}\StringTok{ }\KeywordTok{glm}\NormalTok{(qsmk }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{sex }\OperatorTok{+}\StringTok{ }\NormalTok{race }\OperatorTok{+}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }\KeywordTok{I}\NormalTok{(age}\OperatorTok{*}\NormalTok{age)}
              \OperatorTok{+}\StringTok{ }\KeywordTok{as.factor}\NormalTok{(education) }\OperatorTok{+}\StringTok{ }\NormalTok{smokeintensity}
              \OperatorTok{+}\StringTok{ }\KeywordTok{I}\NormalTok{(smokeintensity}\OperatorTok{*}\NormalTok{smokeintensity) }\OperatorTok{+}\StringTok{ }\NormalTok{smokeyrs}
              \OperatorTok{+}\StringTok{ }\KeywordTok{I}\NormalTok{(smokeyrs}\OperatorTok{*}\NormalTok{smokeyrs) }\OperatorTok{+}\StringTok{ }\KeywordTok{as.factor}\NormalTok{(exercise)}
              \OperatorTok{+}\StringTok{ }\KeywordTok{as.factor}\NormalTok{(active) }\OperatorTok{+}\StringTok{ }\NormalTok{wt71 }\OperatorTok{+}\StringTok{ }\KeywordTok{I}\NormalTok{(wt71}\OperatorTok{*}\NormalTok{wt71),}
...
\NormalTok{nhefs}\OperatorTok{$}\NormalTok{p.qsmk \textless{}{-}}\StringTok{ }\KeywordTok{predict}\NormalTok{(modelA, nhefs, }\DataTypeTok{type=}\StringTok{"response"}\NormalTok{) }
\NormalTok{d \textless{}{-}}\StringTok{ }\NormalTok{nhefs[}\OperatorTok{!}\KeywordTok{is.na}\NormalTok{(nhefs}\OperatorTok{$}\NormalTok{survtime),] }\CommentTok{\# select only those with observed death time}
\NormalTok{n \textless{}{-}}\StringTok{ }\KeywordTok{nrow}\NormalTok{(d)}

\CommentTok{\# define the estimating function that needs to be minimized}
\NormalTok{sumeef \textless{}{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(psi)\{}
  
  \CommentTok{\# creation of delta indicator}
  \ControlFlowTok{if}\NormalTok{ (psi}\OperatorTok{\textgreater{}=}\DecValTok{0}\NormalTok{)\{}
\NormalTok{    delta \textless{}{-}}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(d}\OperatorTok{$}\NormalTok{qsmk}\OperatorTok{==}\DecValTok{0} \OperatorTok{|}\StringTok{ }
\StringTok{                      }\NormalTok{(d}\OperatorTok{$}\NormalTok{qsmk}\OperatorTok{==}\DecValTok{1} \OperatorTok{\&}\StringTok{ }\NormalTok{psi }\OperatorTok{\textless{}=}\StringTok{ }\KeywordTok{log}\NormalTok{(}\DecValTok{120}\OperatorTok{/}\NormalTok{d}\OperatorTok{$}\NormalTok{survtime)), }
                    \DecValTok{1}\NormalTok{, }\DecValTok{0}\NormalTok{)}
\NormalTok{  \} }\ControlFlowTok{else} \ControlFlowTok{if}\NormalTok{ (psi }\OperatorTok{\textless{}}\StringTok{ }\DecValTok{0}\NormalTok{) \{}
\NormalTok{    delta \textless{}{-}}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(d}\OperatorTok{$}\NormalTok{qsmk}\OperatorTok{==}\DecValTok{1} \OperatorTok{|}\StringTok{ }
\StringTok{                      }\NormalTok{(d}\OperatorTok{$}\NormalTok{qsmk}\OperatorTok{==}\DecValTok{0} \OperatorTok{\&}\StringTok{ }\NormalTok{psi }\OperatorTok{\textgreater{}}\StringTok{ }\KeywordTok{log}\NormalTok{(d}\OperatorTok{$}\NormalTok{survtime}\OperatorTok{/}\DecValTok{120}\NormalTok{)), }\DecValTok{1}\NormalTok{, }\DecValTok{0}\NormalTok{)}
\NormalTok{  \}}
  
\NormalTok{  smat \textless{}{-}}\StringTok{ }\NormalTok{delta}\OperatorTok{*}\NormalTok{(d}\OperatorTok{$}\NormalTok{qsmk}\OperatorTok{{-}}\NormalTok{d}\OperatorTok{$}\NormalTok{p.qsmk)}
\NormalTok{  sval \textless{}{-}}\StringTok{ }\KeywordTok{sum}\NormalTok{(smat, }\DataTypeTok{na.rm=}\NormalTok{T)}
\NormalTok{  save \textless{}{-}}\StringTok{ }\NormalTok{sval}\OperatorTok{/}\NormalTok{n}
\NormalTok{  smat \textless{}{-}}\StringTok{ }\NormalTok{smat }\OperatorTok{{-}}\StringTok{ }\KeywordTok{rep}\NormalTok{(save, n)}
  
  \CommentTok{\# covariance}
\NormalTok{  sigma \textless{}{-}}\StringTok{ }\KeywordTok{t}\NormalTok{(smat) }\OperatorTok{\%*\%}\StringTok{ }\NormalTok{smat}
  \ControlFlowTok{if}\NormalTok{ (sigma }\OperatorTok{==}\StringTok{ }\DecValTok{0}\NormalTok{)\{}
\NormalTok{    sigma \textless{}{-}}\StringTok{ }\FloatTok{1e{-}16}
\NormalTok{  \}}
\NormalTok{  estimeq \textless{}{-}}\StringTok{ }\NormalTok{sval}\OperatorTok{*}\KeywordTok{solve}\NormalTok{(sigma)}\OperatorTok{*}\KeywordTok{t}\NormalTok{(sval)}
  \KeywordTok{return}\NormalTok{(estimeq)}
\NormalTok{\}}

\NormalTok{res \textless{}{-}}\StringTok{ }\KeywordTok{optimize}\NormalTok{(sumeef, }\DataTypeTok{interval =} \KeywordTok{c}\NormalTok{(}\OperatorTok{{-}}\FloatTok{0.2}\NormalTok{,}\FloatTok{0.2}\NormalTok{))}
\NormalTok{psi1 \textless{}{-}}\StringTok{ }\NormalTok{res}\OperatorTok{$}\NormalTok{minimum}
\NormalTok{objfunc \textless{}{-}}\StringTok{ }\KeywordTok{as.numeric}\NormalTok{(res}\OperatorTok{$}\NormalTok{objective)}


\CommentTok{\# Use simple bisection method to find estimates of lower and upper 95\% confidence bounds}
\NormalTok{increm \textless{}{-}}\StringTok{ }\FloatTok{0.1}
\NormalTok{for\_conf \textless{}{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(x)\{}
  \KeywordTok{return}\NormalTok{(}\KeywordTok{sumeef}\NormalTok{(x) }\OperatorTok{{-}}\StringTok{ }\FloatTok{3.84}\NormalTok{)}
\NormalTok{\}}

\ControlFlowTok{if}\NormalTok{ (objfunc }\OperatorTok{\textless{}}\StringTok{ }\FloatTok{3.84}\NormalTok{)\{}
  \CommentTok{\# Find estimate of where sumeef(x) \textgreater{} 3.84}
  
  \CommentTok{\# Lower bound of 95\% CI}
\NormalTok{  psilow \textless{}{-}}\StringTok{ }\NormalTok{psi1}
\NormalTok{  testlow \textless{}{-}}\StringTok{ }\NormalTok{objfunc}
\NormalTok{  countlow \textless{}{-}}\StringTok{ }\DecValTok{0}
  \ControlFlowTok{while}\NormalTok{ (testlow }\OperatorTok{\textless{}}\StringTok{ }\FloatTok{3.84} \OperatorTok{\&}\StringTok{ }\NormalTok{countlow }\OperatorTok{\textless{}}\StringTok{ }\DecValTok{100}\NormalTok{)\{}
\NormalTok{    psilow \textless{}{-}}\StringTok{ }\NormalTok{psilow }\OperatorTok{{-}}\StringTok{ }\NormalTok{increm}
\NormalTok{    testlow \textless{}{-}}\StringTok{ }\KeywordTok{sumeef}\NormalTok{(psilow)}
\NormalTok{    countlow \textless{}{-}}\StringTok{ }\NormalTok{countlow }\OperatorTok{+}\StringTok{ }\DecValTok{1}
\NormalTok{  \}}
  
  \CommentTok{\# Upper bound of 95\% CI}
\NormalTok{  psihigh \textless{}{-}}\StringTok{ }\NormalTok{psi1}
\NormalTok{  testhigh \textless{}{-}}\StringTok{ }\NormalTok{objfunc}
\NormalTok{  counthigh \textless{}{-}}\StringTok{ }\DecValTok{0}
  \ControlFlowTok{while}\NormalTok{ (testhigh }\OperatorTok{\textless{}}\StringTok{ }\FloatTok{3.84} \OperatorTok{\&}\StringTok{ }\NormalTok{counthigh }\OperatorTok{\textless{}}\StringTok{ }\DecValTok{100}\NormalTok{)\{}
\NormalTok{    psihigh \textless{}{-}}\StringTok{ }\NormalTok{psihigh }\OperatorTok{+}\StringTok{ }\NormalTok{increm}
\NormalTok{    testhigh \textless{}{-}}\StringTok{ }\KeywordTok{sumeef}\NormalTok{(psihigh)}
\NormalTok{    counthigh \textless{}{-}}\StringTok{ }\NormalTok{counthigh }\OperatorTok{+}\StringTok{ }\DecValTok{1}
\NormalTok{  \}}
...
Available physical memory: 23761292 KB
