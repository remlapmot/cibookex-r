...
\DocumentationTok{\#\# 1                 Observed 2.56188497106099 0.177244121594006  2.2144928762653}
\DocumentationTok{\#\# 2             No Treatment 1.65212306626741 0.144724080583739 1.36846908062761}
\DocumentationTok{\#\# 3                Treatment 5.11474489549342 0.394902377875389 4.34075045744843}
\DocumentationTok{\#\# 4 Treatment {-} No Treatment 3.46262182922601 0.304733530615214 2.86535508433846}
\DocumentationTok{\#\#                 ul}
\DocumentationTok{\#\# 1 2.90927706585667}
\DocumentationTok{\#\# 2 1.93577705190721}
\DocumentationTok{\#\# 3 5.88873933353841}
\DocumentationTok{\#\# 4 4.05988857411356}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# Loading required package: Formula}
\DocumentationTok{\#\# Loading required package: ggplot2}
\DocumentationTok{\#\# }
...
\NormalTok{bootstrap}
\DocumentationTok{\#\#                         V1             mean                se               ll}
\DocumentationTok{\#\# 1                 Observed 2.63384609228479 0.204109541560683 2.23379874192487}
\DocumentationTok{\#\# 2             No Treatment 1.71983636149843 0.199709774124416 1.32841239685394}
\DocumentationTok{\#\# 3                Treatment 5.35072300362993 0.236569049531324 4.88705618669166}
\DocumentationTok{\#\# 4 Treatment {-} No Treatment  3.6308866421315 0.274311077093653 3.09324681046755}
\DocumentationTok{\#\#                 ul}
\DocumentationTok{\#\# 1 3.03389344264471}
\DocumentationTok{\#\# 2 2.11126032614291}
\DocumentationTok{\#\# 3 5.81438982056819}
\DocumentationTok{\#\# 4 4.16852647379545}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# 2.70279 , 4.362397}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\#  version  R version 4.2.2 (2022{-}10{-}31)}
\DocumentationTok{\#\#  os       macOS Ventura 13.0}
\DocumentationTok{\#\#  system   aarch64, darwin20}
\DocumentationTok{\#\#  ui       X11}
\DocumentationTok{\#\#  language (EN)}
\DocumentationTok{\#\#  collate  en\_GB.UTF{-}8}
\DocumentationTok{\#\#  ctype    en\_GB.UTF{-}8}
\DocumentationTok{\#\#  tz       Europe/London}
\DocumentationTok{\#\#  date     2022{-}11{-}02}
\DocumentationTok{\#\#  pandoc   2.19.2 @ /Applications/RStudio.app/Contents/Resources/app/quarto/bin/tools/ (via rmarkdown)}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# {-} Packages {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\DocumentationTok{\#\#  package     * version date (UTC) lib source}
\DocumentationTok{\#\#  bookdown      0.29    2022{-}09{-}12 [3] CRAN (R 4.2.1)}
\DocumentationTok{\#\#  cli           3.4.1   2022{-}09{-}23 [1] CRAN (R 4.2.1)}
\DocumentationTok{\#\#  digest        0.6.30  2022{-}10{-}18 [3] CRAN (R 4.2.1)}
\DocumentationTok{\#\#  evaluate      0.17    2022{-}10{-}07 [3] CRAN (R 4.2.0)}
\DocumentationTok{\#\#  fastmap       1.1.0   2021{-}01{-}25 [3] CRAN (R 4.2.0)}
\DocumentationTok{\#\#  htmltools     0.5.3   2022{-}07{-}18 [3] CRAN (R 4.2.1)}
\DocumentationTok{\#\#  knitr         1.40    2022{-}08{-}24 [3] CRAN (R 4.2.1)}
\DocumentationTok{\#\#  magrittr      2.0.3   2022{-}03{-}30 [3] CRAN (R 4.2.0)}
\DocumentationTok{\#\#  rlang         1.0.6   2022{-}09{-}24 [3] CRAN (R 4.2.0)}
\DocumentationTok{\#\#  rmarkdown     2.17    2022{-}10{-}07 [3] CRAN (R 4.2.0)}
\DocumentationTok{\#\#  rstudioapi    0.14    2022{-}08{-}22 [3] CRAN (R 4.2.1)}
\DocumentationTok{\#\#  sessioninfo   1.2.2   2021{-}12{-}06 [3] CRAN (R 4.2.0)}
\DocumentationTok{\#\#  stringi       1.7.8   2022{-}07{-}11 [3] CRAN (R 4.2.1)}
\DocumentationTok{\#\#  stringr       1.4.1   2022{-}08{-}20 [3] CRAN (R 4.2.0)}
\DocumentationTok{\#\#  xfun          0.34    2022{-}10{-}18 [3] CRAN (R 4.2.1)}
\DocumentationTok{\#\#  yaml          2.3.6   2022{-}10{-}18 [3] CRAN (R 4.2.1)}
\DocumentationTok{\#\# }
\DocumentationTok{\#\#  [1] /Users/tom/Library/R/arm64/4.2/library}
\DocumentationTok{\#\#  [2] /Library/Frameworks/R.framework/Versions/4.2{-}arm64/Resources/site{-}library}
\DocumentationTok{\#\#  [3] /Library/Frameworks/R.framework/Versions/4.2{-}arm64/Resources/library}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{ version  R version }\DecValTok{4}\NormalTok{.}\FloatTok{2.2}\NormalTok{ (}\DecValTok{2022{-}10{-}31}\NormalTok{)}
\NormalTok{ os       macOS Ventura }\FloatTok{13.0}
\NormalTok{ system   aarch64, darwin20}
\NormalTok{ ui       X11}
 \FunctionTok{language}\NormalTok{ (EN)}
\NormalTok{ collate  en\_GB.UTF}\DecValTok{{-}8}
\NormalTok{ ctype    en\_GB.UTF}\DecValTok{{-}8}
\NormalTok{ tz       Europe}\SpecialCharTok{/}\NormalTok{London}
\NormalTok{ date     }\DecValTok{2022{-}11{-}02}
\NormalTok{ pandoc   }\DecValTok{2}\NormalTok{.}\FloatTok{19.2} \SpecialCharTok{@} \ErrorTok{/}\NormalTok{Applications}\SpecialCharTok{/}\NormalTok{RStudio.app}\SpecialCharTok{/}\NormalTok{Contents}\SpecialCharTok{/}\NormalTok{Resources}\SpecialCharTok{/}\NormalTok{app}\SpecialCharTok{/}\NormalTok{quarto}\SpecialCharTok{/}\NormalTok{bin}\SpecialCharTok{/}\NormalTok{tools}\SpecialCharTok{/}\NormalTok{ (via rmarkdown)}
...
\NormalTok{ bookdown        }\FloatTok{0.29}    \DecValTok{2022{-}09{-}12}\NormalTok{ [}\DecValTok{3}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.1}\NormalTok{)}
\NormalTok{ cli             }\DecValTok{3}\NormalTok{.}\FloatTok{4.1}   \DecValTok{2022{-}09{-}23}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.1}\NormalTok{)}
\NormalTok{ digest          }\DecValTok{0}\NormalTok{.}\FloatTok{6.30}  \DecValTok{2022{-}10{-}18}\NormalTok{ [}\DecValTok{3}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.1}\NormalTok{)}
\NormalTok{ evaluate        }\FloatTok{0.17}    \DecValTok{2022{-}10{-}07}\NormalTok{ [}\DecValTok{3}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.0}\NormalTok{)}
\NormalTok{ fastmap         }\DecValTok{1}\NormalTok{.}\FloatTok{1.0}   \DecValTok{2021{-}01{-}25}\NormalTok{ [}\DecValTok{3}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.0}\NormalTok{)}
\NormalTok{ htmltools       }\DecValTok{0}\NormalTok{.}\FloatTok{5.3}   \DecValTok{2022{-}07{-}18}\NormalTok{ [}\DecValTok{3}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.1}\NormalTok{)}
\NormalTok{ knitr           }\FloatTok{1.40}    \DecValTok{2022{-}08{-}24}\NormalTok{ [}\DecValTok{3}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.1}\NormalTok{)}
\NormalTok{ magrittr        }\DecValTok{2}\NormalTok{.}\FloatTok{0.3}   \DecValTok{2022{-}03{-}30}\NormalTok{ [}\DecValTok{3}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.0}\NormalTok{)}
\NormalTok{ rlang           }\DecValTok{1}\NormalTok{.}\FloatTok{0.6}   \DecValTok{2022{-}09{-}24}\NormalTok{ [}\DecValTok{3}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.0}\NormalTok{)}
\NormalTok{ rmarkdown       }\FloatTok{2.17}    \DecValTok{2022{-}10{-}07}\NormalTok{ [}\DecValTok{3}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.0}\NormalTok{)}
\NormalTok{ rstudioapi      }\FloatTok{0.14}    \DecValTok{2022{-}08{-}22}\NormalTok{ [}\DecValTok{3}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.1}\NormalTok{)}
\NormalTok{ sessioninfo     }\DecValTok{1}\NormalTok{.}\FloatTok{2.2}   \DecValTok{2021{-}12{-}06}\NormalTok{ [}\DecValTok{3}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.0}\NormalTok{)}
\NormalTok{ Statamarkdown }\SpecialCharTok{*} \DecValTok{0}\NormalTok{.}\FloatTok{7.1}   \DecValTok{2022{-}05{-}13}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{Github}\NormalTok{ (Hemken}\SpecialCharTok{/}\NormalTok{Statamarkdown}\SpecialCharTok{@}\NormalTok{d9cbb1a)}
\NormalTok{ stringi         }\DecValTok{1}\NormalTok{.}\FloatTok{7.8}   \DecValTok{2022{-}07{-}11}\NormalTok{ [}\DecValTok{3}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.1}\NormalTok{)}
\NormalTok{ stringr         }\DecValTok{1}\NormalTok{.}\FloatTok{4.1}   \DecValTok{2022{-}08{-}20}\NormalTok{ [}\DecValTok{3}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.0}\NormalTok{)}
\NormalTok{ xfun            }\FloatTok{0.34}    \DecValTok{2022{-}10{-}18}\NormalTok{ [}\DecValTok{3}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.1}\NormalTok{)}
\NormalTok{ yaml            }\DecValTok{2}\NormalTok{.}\FloatTok{3.6}   \DecValTok{2022{-}10{-}18}\NormalTok{ [}\DecValTok{3}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.1}\NormalTok{)}

\NormalTok{ [}\DecValTok{1}\NormalTok{] }\SpecialCharTok{/}\NormalTok{Users}\SpecialCharTok{/}\NormalTok{tom}\SpecialCharTok{/}\NormalTok{Library}\SpecialCharTok{/}\NormalTok{R}\SpecialCharTok{/}\NormalTok{arm64}\SpecialCharTok{/}\FloatTok{4.2}\SpecialCharTok{/}\NormalTok{library}
\NormalTok{ [}\DecValTok{2}\NormalTok{] }\SpecialCharTok{/}\NormalTok{Library}\SpecialCharTok{/}\NormalTok{Frameworks}\SpecialCharTok{/}\NormalTok{R.framework}\SpecialCharTok{/}\NormalTok{Versions}\SpecialCharTok{/}\FloatTok{4.2}\SpecialCharTok{{-}}\NormalTok{arm64}\SpecialCharTok{/}\NormalTok{Resources}\SpecialCharTok{/}\NormalTok{site}\SpecialCharTok{{-}}\NormalTok{library}
\NormalTok{ [}\DecValTok{3}\NormalTok{] }\SpecialCharTok{/}\NormalTok{Library}\SpecialCharTok{/}\NormalTok{Frameworks}\SpecialCharTok{/}\NormalTok{R.framework}\SpecialCharTok{/}\NormalTok{Versions}\SpecialCharTok{/}\FloatTok{4.2}\SpecialCharTok{{-}}\NormalTok{arm64}\SpecialCharTok{/}\NormalTok{Resources}\SpecialCharTok{/}\NormalTok{library}
