...
\DocumentationTok{\#\# 1                 Observed 2.56188497106099 0.100880560037889 2.36416270664649}
\DocumentationTok{\#\# 2             No Treatment 1.65212306626744 0.175544457433156 1.30806225201283}
\DocumentationTok{\#\# 3                Treatment 5.11474489549336 0.398009040062483 4.33466151144953}
\DocumentationTok{\#\# 4 Treatment {-} No Treatment 3.46262182922592 0.542169235265909 2.39998965457911}
\DocumentationTok{\#\#                 ul}
\DocumentationTok{\#\# 1 2.75960723547548}
\DocumentationTok{\#\# 2 1.99618388052205}
\DocumentationTok{\#\# 3 5.89482827953718}
\DocumentationTok{\#\# 4 4.52525400387272}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{bootstrap}
\DocumentationTok{\#\#                         V1             mean                se               ll}
\DocumentationTok{\#\# 1                 Observed 2.63384609228479 0.293000454454304 2.05957575410049}
\DocumentationTok{\#\# 2             No Treatment 1.71983636149845 0.277586833732187 1.17577616480086}
\DocumentationTok{\#\# 3                Treatment 5.35072300362985 0.489422523077058  4.3914724851761}
\DocumentationTok{\#\# 4 Treatment {-} No Treatment  3.6308866421314 0.464643860468904  2.7202014099747}
\DocumentationTok{\#\#                 ul}
\DocumentationTok{\#\# 1  3.2081164304691}
\DocumentationTok{\#\# 2 2.26389655819605}
\DocumentationTok{\#\# 3 6.30997352208361}
\DocumentationTok{\#\# 4  4.5415718742881}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# 2.63153 , 4.399715}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\#  version  R version 4.3.0 (2023{-}04{-}21)}
\DocumentationTok{\#\#  os       macOS Ventura 13.3.1}
...
\DocumentationTok{\#\#  date     2023{-}04{-}24}
\DocumentationTok{\#\#  pandoc   3.1.2 @ /opt/homebrew/bin/ (via rmarkdown)}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# {-} Packages {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\DocumentationTok{\#\#  package     * version date (UTC) lib source}
\DocumentationTok{\#\#  bookdown      0.33    2023{-}03{-}06 [1] CRAN (R 4.3.0)}
\DocumentationTok{\#\#  cli           3.6.1   2023{-}03{-}23 [1] CRAN (R 4.3.0)}
\DocumentationTok{\#\#  digest        0.6.31  2022{-}12{-}11 [1] CRAN (R 4.3.0)}
\DocumentationTok{\#\#  evaluate      0.20    2023{-}01{-}17 [1] CRAN (R 4.3.0)}
\DocumentationTok{\#\#  fastmap       1.1.1   2023{-}02{-}24 [1] CRAN (R 4.3.0)}
\DocumentationTok{\#\#  htmltools     0.5.5   2023{-}03{-}23 [1] CRAN (R 4.3.0)}
\DocumentationTok{\#\#  knitr         1.42.7  2023{-}04{-}24 [1] Github (yihui/knitr@5ce5531)}
\DocumentationTok{\#\#  rlang         1.1.0   2023{-}03{-}14 [1] CRAN (R 4.3.0)}
\DocumentationTok{\#\#  rmarkdown     2.21    2023{-}03{-}26 [1] CRAN (R 4.3.0)}
...
\NormalTok{ version  R version }\DecValTok{4}\NormalTok{.}\FloatTok{3.0}\NormalTok{ (}\DecValTok{2023{-}04{-}21}\NormalTok{)}
\NormalTok{ os       macOS Ventura }\DecValTok{13}\NormalTok{.}\FloatTok{3.1}
...
\NormalTok{ date     }\DecValTok{2023{-}04{-}24}
\NormalTok{ pandoc   }\DecValTok{3}\NormalTok{.}\FloatTok{1.2} \SpecialCharTok{@} \ErrorTok{/}\NormalTok{opt}\SpecialCharTok{/}\NormalTok{homebrew}\SpecialCharTok{/}\NormalTok{bin}\SpecialCharTok{/}\NormalTok{ (via rmarkdown)}
...
\NormalTok{ bookdown        }\FloatTok{0.33}    \DecValTok{2023{-}03{-}06}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{3.0}\NormalTok{)}
...
\NormalTok{ evaluate        }\FloatTok{0.20}    \DecValTok{2023{-}01{-}17}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{3.0}\NormalTok{)}
...
\NormalTok{ knitr           }\DecValTok{1}\NormalTok{.}\FloatTok{42.7}  \DecValTok{2023{-}04{-}24}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{Github}\NormalTok{ (yihui}\SpecialCharTok{/}\NormalTok{knitr}\SpecialCharTok{@}\NormalTok{5ce5531)}
\NormalTok{ rlang           }\DecValTok{1}\NormalTok{.}\FloatTok{1.0}   \DecValTok{2023{-}03{-}14}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{3.0}\NormalTok{)}
\NormalTok{ rmarkdown       }\FloatTok{2.21}    \DecValTok{2023{-}03{-}26}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{3.0}\NormalTok{)}
...
\NormalTok{ Statamarkdown }\SpecialCharTok{*} \DecValTok{0}\NormalTok{.}\FloatTok{7.2}   \DecValTok{2023{-}02{-}15}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{3.0}\NormalTok{)}
