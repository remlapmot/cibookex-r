...
\DocumentationTok{\#\# {-}61.930  {-}30.564   {-}5.741   30.653   77.225  }
\DocumentationTok{\#\# }
...
\DocumentationTok{\#\# Deviance Residuals: }
\DocumentationTok{\#\#     Min       1Q   Median       3Q      Max  }
\DocumentationTok{\#\# {-}96.250  {-}40.000    3.125   35.938  102.500  }
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Coefficients:}
\DocumentationTok{\#\#             Estimate Std. Error t value Pr(\textgreater{}|t|)   }
...
\DocumentationTok{\#\# Deviance Residuals: }
\DocumentationTok{\#\#    Min      1Q  Median      3Q     Max  }
\DocumentationTok{\#\# {-}65.27  {-}34.41   13.21   26.11   64.36  }
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Coefficients:}
\DocumentationTok{\#\#             Estimate Std. Error t value Pr(\textgreater{}|t|)  }
...
\DocumentationTok{\#\# Deviance Residuals: }
\DocumentationTok{\#\#     Min       1Q   Median       3Q      Max  }
\DocumentationTok{\#\# {-}1.5127  {-}0.7907  {-}0.6387   0.9832   2.3729  }
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Coefficients:}
...
\DocumentationTok{\#\# Deviance Residuals: }
\DocumentationTok{\#\#    Min      1Q  Median      3Q     Max  }
\DocumentationTok{\#\# {-}1.513  {-}0.791  {-}0.639   0.983   2.373  }
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Coefficients:}
\DocumentationTok{\#\#                        Estimate Std. Error z value Pr(\textgreater{}|z|)    }
...
\DocumentationTok{\#\# Deviance Residuals: }
\DocumentationTok{\#\#    Min      1Q  Median      3Q     Max  }
\DocumentationTok{\#\# {-}0.771  {-}0.771  {-}0.771   1.648   1.648  }
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Coefficients:}
\DocumentationTok{\#\#             Estimate Std. Error z value Pr(\textgreater{}|z|)    }
...
\DocumentationTok{\#\# Deviance Residuals: }
\DocumentationTok{\#\#    Min      1Q  Median      3Q     Max  }
\DocumentationTok{\#\# {-}0.825  {-}0.825  {-}0.719   1.576   1.720  }
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Coefficients:}
\DocumentationTok{\#\#                 Estimate Std. Error z value Pr(\textgreater{}|z|)    }
...
\DocumentationTok{\#\# Deviance Residuals: }
\DocumentationTok{\#\#    Min      1Q  Median      3Q     Max  }
\DocumentationTok{\#\# {-}1.465  {-}0.804  {-}0.646   1.058   2.355  }
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Coefficients:}
\DocumentationTok{\#\#                        Estimate Std. Error z value Pr(\textgreater{}|z|)    }
...
\DocumentationTok{\#\# Deviance Residuals: }
\DocumentationTok{\#\#    Min      1Q  Median      3Q     Max  }
\DocumentationTok{\#\# {-}0.781  {-}0.781  {-}0.781   1.635   1.635  }
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Coefficients:}
\DocumentationTok{\#\#             Estimate Std. Error z value Pr(\textgreater{}|z|)    }
...
\DocumentationTok{\#\# Deviance Residuals: }
\DocumentationTok{\#\#    Min      1Q  Median      3Q     Max  }
\DocumentationTok{\#\# {-}1.097  {-}0.287  {-}0.207  {-}0.157   2.996  }
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Coefficients:}
\DocumentationTok{\#\#                        Estimate Std. Error z value Pr(\textgreater{}|z|)   }
...
\DocumentationTok{\#\# Deviance Residuals: }
\DocumentationTok{\#\#    Min      1Q  Median      3Q     Max  }
\DocumentationTok{\#\# {-}0.347  {-}0.254  {-}0.254  {-}0.254   2.628  }
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Coefficients:}
\DocumentationTok{\#\#                  Estimate Std. Error z value Pr(\textgreater{}|z|)    }
...
\DocumentationTok{\#\# Deviance Residuals: }
\DocumentationTok{\#\#     Min       1Q   Median       3Q      Max  }
\DocumentationTok{\#\# {-}42.056   {-}4.171   {-}0.343    3.891   44.606  }
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Coefficients:}
\DocumentationTok{\#\#                                      Estimate Std. Error t value Pr(\textgreater{}|t|)    }
...
\DocumentationTok{\#\#   predict\textasciitilde{}1  qsmk   sex  race   age educa\textasciitilde{}2 smoke\textasciitilde{}3 smoke\textasciitilde{}4 exerc\textasciitilde{}5 active  wt71}
...
\DocumentationTok{\#\# 1     0.342     0     0     0    26       4      15      12       1      0  112.}
\DocumentationTok{\#\# \# ... with abbreviated variable names 1: predicted.meanY, 2: education,}
\DocumentationTok{\#\# \#   3: smokeintensity, 4: smokeyrs, 5: exercise}
...
\DocumentationTok{\#\# Deviance Residuals: }
\DocumentationTok{\#\#      Min        1Q    Median        3Q       Max  }
\DocumentationTok{\#\# {-}0.66667  {-}0.25000   0.04167   0.33333   0.75000  }
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Coefficients:}
\DocumentationTok{\#\#               Estimate Std. Error t value Pr(\textgreater{}|t|)}
\DocumentationTok{\#\# (Intercept)  2.500e{-}01  2.552e{-}01   0.980    0.342}
\DocumentationTok{\#\# A           {-}1.079e{-}16  3.608e{-}01   0.000    1.000}
\DocumentationTok{\#\# L            4.167e{-}01  3.898e{-}01   1.069    0.301}
\DocumentationTok{\#\# A:L         {-}6.935e{-}17  4.959e{-}01   0.000    1.000}
\DocumentationTok{\#\# }
...
\DocumentationTok{\#\# 1                 Observed 2.56188497106099 0.237550927330331 2.09629370899944}
\DocumentationTok{\#\# 2             No Treatment 1.65212306626741 0.241279481801516 1.17922397172795}
\DocumentationTok{\#\# 3                Treatment 5.11474489549342 0.378151880882654 4.37358082827734}
\DocumentationTok{\#\# 4 Treatment {-} No Treatment 3.46262182922601 0.302288942179295 2.87014638962988}
\DocumentationTok{\#\#                 ul}
\DocumentationTok{\#\# 1 3.02747623312253}
\DocumentationTok{\#\# 2 2.12502216080687}
\DocumentationTok{\#\# 3  5.8559089627095}
\DocumentationTok{\#\# 4 4.05509726882214}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# }
\DocumentationTok{\#\# lowest : {-}41.28047 {-}30.50192 {-}30.05007 {-}29.02579 {-}25.97056}
\DocumentationTok{\#\# highest:  34.01780  36.96925  37.65051  47.51130  48.53839}
...
\DocumentationTok{\#\# Deviance Residuals: }
\DocumentationTok{\#\#     Min       1Q   Median       3Q      Max  }
\DocumentationTok{\#\# {-}2.9959   0.1571   0.2069   0.2868   1.0967  }
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Coefficients:}
\DocumentationTok{\#\#                         Estimate Std. Error z value Pr(\textgreater{}|z|)   }
...
\DocumentationTok{\#\# Deviance Residuals: }
\DocumentationTok{\#\#    Min      1Q  Median      3Q     Max  }
\DocumentationTok{\#\# {-}1.529  {-}0.808  {-}0.650   1.029   2.417  }
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Coefficients:}
\DocumentationTok{\#\#                        Estimate Std. Error z value Pr(\textgreater{}|z|)    }
...
\DocumentationTok{\#\# }
\DocumentationTok{\#\# lowest : 0.05145 0.05157 0.05438 0.05583 0.05931}
\DocumentationTok{\#\# highest: 0.67208 0.68643 0.71391 0.73330 0.78914}
...
\DocumentationTok{\#\# Deviance Residuals: }
\DocumentationTok{\#\#     Min       1Q   Median       3Q      Max  }
\DocumentationTok{\#\# {-}42.332   {-}4.216   {-}0.318    3.807   44.668  }
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Coefficients:}
\DocumentationTok{\#\#                                      Estimate Std. Error t value Pr(\textgreater{}|t|)    }
...
\DocumentationTok{\#\# Deviance Residuals: }
\DocumentationTok{\#\#     Min       1Q   Median       3Q      Max  }
\DocumentationTok{\#\# {-}1.4646  {-}0.8044  {-}0.6460   1.0578   2.3550  }
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Coefficients:}
\DocumentationTok{\#\#                                      Estimate Std. Error z value Pr(\textgreater{}|z|)    }
...
\DocumentationTok{\#\# Deviance Residuals: }
\DocumentationTok{\#\#     Min       1Q   Median       3Q      Max  }
\DocumentationTok{\#\# {-}43.543   {-}3.932   {-}0.085    4.233   46.773  }
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Coefficients:}
\DocumentationTok{\#\#                     Estimate Std. Error t value Pr(\textgreater{}|t|)    }
...
\NormalTok{bootstrap}
\DocumentationTok{\#\#                         V1             mean                se               ll}
\DocumentationTok{\#\# 1                 Observed 2.63384609228479 0.206446407610947 2.22921856862966}
\DocumentationTok{\#\# 2             No Treatment 1.71983636149843 0.246407544269266 1.23688644921171}
\DocumentationTok{\#\# 3                Treatment 5.35072300362993 0.485456983760871 4.39924479941517}
\DocumentationTok{\#\# 4 Treatment {-} No Treatment  3.6308866421315 0.456264631809602 2.73662439636525}
\DocumentationTok{\#\#                 ul}
\DocumentationTok{\#\# 1 3.03847361593992}
\DocumentationTok{\#\# 2 2.20278627378515}
\DocumentationTok{\#\# 3 6.30220120784468}
\DocumentationTok{\#\# 4 4.52514888789775}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# Deviance Residuals: }
\DocumentationTok{\#\#     Min       1Q   Median       3Q      Max  }
\DocumentationTok{\#\# {-}43.314   {-}4.006   {-}0.068    4.244   47.158  }
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Coefficients:}
\DocumentationTok{\#\#             Estimate Std. Error t value Pr(\textgreater{}|t|)    }
...
\DocumentationTok{\#\# 2.397213 , 4.668531}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# Deviance Residuals: }
\DocumentationTok{\#\#     Min       1Q   Median       3Q      Max  }
\DocumentationTok{\#\# {-}3.7253   0.0546   0.0601   0.0625   0.0783  }
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Coefficients:}
\DocumentationTok{\#\#                    Estimate Std. Error z value Pr(\textgreater{}|z|)    }
...
\DocumentationTok{\#\# Deviance Residuals: }
\DocumentationTok{\#\#     Min       1Q   Median       3Q      Max  }
\DocumentationTok{\#\# {-}7.1859   0.0528   0.0595   0.0640   0.1452  }
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Coefficients:}
\DocumentationTok{\#\#                    Estimate Std. Error z value Pr(\textgreater{}|z|)    }
...
\DocumentationTok{\#\# Deviance Residuals: }
\DocumentationTok{\#\#     Min       1Q   Median       3Q      Max  }
\DocumentationTok{\#\# {-}4.3160   0.0244   0.0395   0.0640   0.3303  }
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Coefficients:}
\DocumentationTok{\#\#                                      Estimate Std. Error z value Pr(\textgreater{}|z|)    }
...
\DocumentationTok{\#\#  version  R version 4.2.3 (2023{-}03{-}15)}
\DocumentationTok{\#\#  os       macOS Ventura 13.2.1}
...
\DocumentationTok{\#\#  date     2023{-}03{-}19}
\DocumentationTok{\#\#  pandoc   3.1.1 @ /opt/homebrew/bin/ (via rmarkdown)}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# {-} Packages {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\DocumentationTok{\#\#  package     * version date (UTC) lib source}
\DocumentationTok{\#\#  bookdown      0.33    2023{-}03{-}06 [1] CRAN (R 4.2.0)}
\DocumentationTok{\#\#  cli           3.6.0   2023{-}01{-}09 [1] CRAN (R 4.2.2)}
\DocumentationTok{\#\#  digest        0.6.31  2022{-}12{-}11 [1] CRAN (R 4.2.2)}
\DocumentationTok{\#\#  evaluate      0.20    2023{-}01{-}17 [1] CRAN (R 4.2.2)}
\DocumentationTok{\#\#  fastmap       1.1.1   2023{-}02{-}24 [1] CRAN (R 4.2.0)}
\DocumentationTok{\#\#  htmltools     0.5.4   2022{-}12{-}07 [1] CRAN (R 4.2.2)}
\DocumentationTok{\#\#  knitr         1.42.5  2023{-}03{-}15 [1] Github (yihui/knitr@c50d307)}
\DocumentationTok{\#\#  rlang         1.1.0   2023{-}03{-}14 [1] CRAN (R 4.2.2)}
\DocumentationTok{\#\#  rmarkdown     2.20    2023{-}01{-}19 [1] CRAN (R 4.2.2)}
\DocumentationTok{\#\#  rstudioapi    0.14    2022{-}08{-}22 [1] CRAN (R 4.2.1)}
\DocumentationTok{\#\#  sessioninfo   1.2.2   2021{-}12{-}06 [1] CRAN (R 4.2.0)}
\DocumentationTok{\#\#  xfun          0.37    2023{-}01{-}31 [1] CRAN (R 4.2.0)}
\DocumentationTok{\#\#  yaml          2.3.7   2023{-}01{-}23 [1] CRAN (R 4.2.2)}
\DocumentationTok{\#\# }
\DocumentationTok{\#\#  [1] /Library/Frameworks/R.framework/Versions/4.2{-}arm64/Resources/library}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\end{Highlighting}
\end{Shaded}
...
------------------------------------------------------------------------------
1   HIToolbox                           0x00000001addbc5c8 _ZN15MenuBarInstance22EnsureAutoShowObserverEv + 120
2   HIToolbox                           0x00000001addbc188 _ZN15MenuBarInstance14EnableAutoShowEv + 60
3   HIToolbox                           0x00000001add5f310 SetMenuBarObscured + 372
4   HIToolbox                           0x00000001add5eee8 _ZN13HIApplication15HandleActivatedEP14OpaqueEventRefhP15OpaqueWindowPtrh + 172
5   HIToolbox                           0x00000001add58fcc _ZN13HIApplication13EventObserverEjP14OpaqueEventRefPv + 296
6   HIToolbox                           0x00000001add1fcd0 _NotifyEventLoopObservers + 176
7   HIToolbox                           0x00000001add5896c AcquireEventFromQueue + 432
8   HIToolbox                           0x00000001add47c84 ReceiveNextEventCommon + 320
9   HIToolbox                           0x00000001add47b2c _BlockUntilNextEventMatchingListInModeWithFilter + 72
10  AppKit                              0x00000001a78ed84c _DPSNextEvent + 632
11  AppKit                              0x00000001a78ec9dc -[NSApplication(NSEvent) _nextEventMatchingEventMask:untilDate:inMode:dequeue:] + 728
12  StataMP                             0x00000001021a25b8 StataMP + 107960
13  StataMP                             0x00000001021a2724 StataMP + 108324
14  StataMP                             0x00000001021a2b2c StataMP + 109356
15  StataMP                             0x0000000102a92a1c StataMP + 9480732
16  StataMP                             0x0000000102749a0c StataMP + 6035980
17  StataMP                             0x0000000102747c34 StataMP + 6028340
18  StataMP                             0x0000000102739b2c StataMP + 5970732
19  StataMP                             0x00000001029d5e0c StataMP + 8707596
20  StataMP                             0x000000010278ebac StataMP + 6319020
21  StataMP                             0x00000001027a7c08 StataMP + 6421512
22  StataMP                             0x0000000102b9ac9c StataMP + 10562716
23  StataMP                             0x000000010278ebac StataMP + 6319020
24  StataMP                             0x00000001027a7c08 StataMP + 6421512
25  StataMP                             0x0000000102b9affc StataMP + 10563580
26  StataMP                             0x000000010278ebac StataMP + 6319020
27  StataMP                             0x00000001027a7c08 StataMP + 6421512
28  StataMP                             0x0000000102b9affc StataMP + 10563580
29  StataMP                             0x000000010278ebac StataMP + 6319020
30  StataMP                             0x00000001027a7c08 StataMP + 6421512
31  StataMP                             0x000000010278ebac StataMP + 6319020
32  StataMP                             0x00000001027a7c08 StataMP + 6421512
33  StataMP                             0x0000000102b9ac9c StataMP + 10562716
34  StataMP                             0x000000010278e448 StataMP + 6317128
35  StataMP                             0x000000010278b8a0 StataMP + 6305952
36  StataMP                             0x000000010278ebac StataMP + 6319020
37  StataMP                             0x0000000102950f5c StataMP + 8163164
38  StataMP                             0x00000001027f35ec StataMP + 6731244
39  StataMP                             0x000000010278ebac StataMP + 6319020
40  StataMP                             0x00000001027a7c08 StataMP + 6421512
41  StataMP                             0x0000000102b9affc StataMP + 10563580
42  StataMP                             0x000000010278ebac StataMP + 6319020
43  StataMP                             0x00000001027a7c08 StataMP + 6421512
44  StataMP                             0x000000010278ebac StataMP + 6319020
45  StataMP                             0x00000001027a7c08 StataMP + 6421512
46  StataMP                             0x000000010278ebac StataMP + 6319020
47  StataMP                             0x00000001029f42e0 StataMP + 8831712
48  dyld                                0x00000001a425fe50 start + 2544
1   HIToolbox                           0x00000001add4790c _ZN15MenuBarInstance22RemoveAutoShowObserverEv + 44
2   HIToolbox                           0x00000001add5f214 SetMenuBarObscured + 120
3   HIToolbox                           0x00000001add66390 _ZN13HIApplication11FrontUILostEv + 44
4   HIToolbox                           0x00000001add5f04c _ZN13HIApplication15HandleActivatedEP14OpaqueEventRefhP15OpaqueWindowPtrh + 528
5   HIToolbox                           0x00000001add58f70 _ZN13HIApplication13EventObserverEjP14OpaqueEventRefPv + 204
6   HIToolbox                           0x00000001add1fcd0 _NotifyEventLoopObservers + 176
7   HIToolbox                           0x00000001add5896c AcquireEventFromQueue + 432
8   HIToolbox                           0x00000001add47c84 ReceiveNextEventCommon + 320
9   HIToolbox                           0x00000001add47b2c _BlockUntilNextEventMatchingListInModeWithFilter + 72
...
14  StataMP                             0x00000001021a2b2c StataMP + 109356
15  StataMP                             0x0000000102a92a1c StataMP + 9480732
16  StataMP                             0x0000000102459668 StataMP + 2954856
17  libomp.dylib                        0x0000000105e9f60c __kmp_invoke_microtask + 156
\end{verbatim}
...
\NormalTok{ version  R version }\DecValTok{4}\NormalTok{.}\FloatTok{2.3}\NormalTok{ (}\DecValTok{2023{-}03{-}15}\NormalTok{)}
\NormalTok{ os       macOS Ventura }\DecValTok{13}\NormalTok{.}\FloatTok{2.1}
...
\NormalTok{ date     }\DecValTok{2023{-}03{-}19}
\NormalTok{ pandoc   }\DecValTok{3}\NormalTok{.}\FloatTok{1.1} \SpecialCharTok{@} \ErrorTok{/}\NormalTok{opt}\SpecialCharTok{/}\NormalTok{homebrew}\SpecialCharTok{/}\NormalTok{bin}\SpecialCharTok{/}\NormalTok{ (via rmarkdown)}
...
\NormalTok{ bookdown        }\FloatTok{0.33}    \DecValTok{2023{-}03{-}06}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.0}\NormalTok{)}
\NormalTok{ cli             }\DecValTok{3}\NormalTok{.}\FloatTok{6.0}   \DecValTok{2023{-}01{-}09}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.2}\NormalTok{)}
\NormalTok{ digest          }\DecValTok{0}\NormalTok{.}\FloatTok{6.31}  \DecValTok{2022{-}12{-}11}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.2}\NormalTok{)}
\NormalTok{ evaluate        }\FloatTok{0.20}    \DecValTok{2023{-}01{-}17}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.2}\NormalTok{)}
\NormalTok{ fastmap         }\DecValTok{1}\NormalTok{.}\FloatTok{1.1}   \DecValTok{2023{-}02{-}24}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.0}\NormalTok{)}
\NormalTok{ htmltools       }\DecValTok{0}\NormalTok{.}\FloatTok{5.4}   \DecValTok{2022{-}12{-}07}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.2}\NormalTok{)}
\NormalTok{ knitr           }\DecValTok{1}\NormalTok{.}\FloatTok{42.5}  \DecValTok{2023{-}03{-}15}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{Github}\NormalTok{ (yihui}\SpecialCharTok{/}\NormalTok{knitr}\SpecialCharTok{@}\NormalTok{c50d307)}
\NormalTok{ rlang           }\DecValTok{1}\NormalTok{.}\FloatTok{1.0}   \DecValTok{2023{-}03{-}14}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.2}\NormalTok{)}
\NormalTok{ rmarkdown       }\FloatTok{2.20}    \DecValTok{2023{-}01{-}19}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.2}\NormalTok{)}
\NormalTok{ rstudioapi      }\FloatTok{0.14}    \DecValTok{2022{-}08{-}22}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.1}\NormalTok{)}
\NormalTok{ sessioninfo     }\DecValTok{1}\NormalTok{.}\FloatTok{2.2}   \DecValTok{2021{-}12{-}06}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.0}\NormalTok{)}
\NormalTok{ Statamarkdown }\SpecialCharTok{*} \DecValTok{0}\NormalTok{.}\FloatTok{7.2}   \DecValTok{2023{-}02{-}15}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.0}\NormalTok{)}
\NormalTok{ xfun            }\FloatTok{0.37}    \DecValTok{2023{-}01{-}31}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.0}\NormalTok{)}
\NormalTok{ yaml            }\DecValTok{2}\NormalTok{.}\FloatTok{3.7}   \DecValTok{2023{-}01{-}23}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.2}\NormalTok{)}

\NormalTok{ [}\DecValTok{1}\NormalTok{] }\SpecialCharTok{/}\NormalTok{Library}\SpecialCharTok{/}\NormalTok{Frameworks}\SpecialCharTok{/}\NormalTok{R.framework}\SpecialCharTok{/}\NormalTok{Versions}\SpecialCharTok{/}\FloatTok{4.2}\SpecialCharTok{{-}}\NormalTok{arm64}\SpecialCharTok{/}\NormalTok{Resources}\SpecialCharTok{/}\NormalTok{library}
