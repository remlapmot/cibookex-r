...
\DocumentationTok{\#\# 1                 Observed 2.56188497106099 0.232550903724213 2.10609357518929}
\DocumentationTok{\#\# 2             No Treatment 1.65212306626741  0.29675878865874 1.07048652840055}
\DocumentationTok{\#\# 3                Treatment 5.11474489549342 0.490286033020929 4.15380192864939}
\DocumentationTok{\#\# 4 Treatment {-} No Treatment 3.46262182922601 0.611809599352042 2.26349704910013}
\DocumentationTok{\#\#                 ul}
\DocumentationTok{\#\# 1 3.01767636693268}
\DocumentationTok{\#\# 2 2.23375960413428}
\DocumentationTok{\#\# 3 6.07568786233746}
\DocumentationTok{\#\# 4 4.66174660935189}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{bootstrap}
\DocumentationTok{\#\#                         V1             mean                se               ll}
\DocumentationTok{\#\# 1                 Observed 2.63384609228479 0.187227245593644 2.26688743399661}
\DocumentationTok{\#\# 2             No Treatment 1.71983636149843 0.227424551595949 1.27409243117019}
\DocumentationTok{\#\# 3                Treatment 5.35072300362993    0.293054401725   4.776346930738}
\DocumentationTok{\#\# 4 Treatment {-} No Treatment  3.6308866421315 0.308067804933338 3.02708483966585}
\DocumentationTok{\#\#                 ul}
\DocumentationTok{\#\# 1 3.00080475057297}
\DocumentationTok{\#\# 2 2.16558029182666}
\DocumentationTok{\#\# 3 5.92509907652186}
\DocumentationTok{\#\# 4 4.23468844459715}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# 2.586018 , 4.448461}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\#  tz       Europe/Berlin}
\DocumentationTok{\#\#  date     2023{-}02{-}15}
\DocumentationTok{\#\#  pandoc   3.1 @ /opt/homebrew/bin/ (via rmarkdown)}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# {-} Packages {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\DocumentationTok{\#\#  package     * version date (UTC) lib source}
\DocumentationTok{\#\#  bookdown      0.32    2023{-}01{-}17 [1] CRAN (R 4.2.0)}
...
\DocumentationTok{\#\#  fastmap       1.1.0   2021{-}01{-}25 [1] CRAN (R 4.2.0)}
\DocumentationTok{\#\#  htmltools     0.5.4   2022{-}12{-}07 [1] CRAN (R 4.2.2)}
\DocumentationTok{\#\#  knitr         1.42    2023{-}01{-}25 [1] CRAN (R 4.2.0)}
\DocumentationTok{\#\#  rlang         1.0.6   2022{-}09{-}24 [1] CRAN (R 4.2.0)}
...
\NormalTok{ date     }\DecValTok{2023{-}02{-}15}
\NormalTok{ pandoc   }\FloatTok{3.1} \SpecialCharTok{@} \ErrorTok{/}\NormalTok{opt}\SpecialCharTok{/}\NormalTok{homebrew}\SpecialCharTok{/}\NormalTok{bin}\SpecialCharTok{/}\NormalTok{ (via rmarkdown)}
...
\NormalTok{ bookdown        }\FloatTok{0.32}    \DecValTok{2023{-}01{-}17}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.0}\NormalTok{)}
...
\NormalTok{ fastmap         }\DecValTok{1}\NormalTok{.}\FloatTok{1.0}   \DecValTok{2021{-}01{-}25}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.0}\NormalTok{)}
...
\NormalTok{ knitr           }\FloatTok{1.42}    \DecValTok{2023{-}01{-}25}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.0}\NormalTok{)}
\NormalTok{ rlang           }\DecValTok{1}\NormalTok{.}\FloatTok{0.6}   \DecValTok{2022{-}09{-}24}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.0}\NormalTok{)}
