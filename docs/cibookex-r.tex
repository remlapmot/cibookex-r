...
\DocumentationTok{\#\# 1                 Observed 2.56188497106099   0.1733270156651 2.22217026280958}
\DocumentationTok{\#\# 2             No Treatment 1.65212306626741 0.213774463021324 1.23313281793123}
\DocumentationTok{\#\# 3                Treatment 5.11474489549342 0.274685235043587 4.57637172772307}
\DocumentationTok{\#\# 4 Treatment {-} No Treatment 3.46262182922601 0.332020679033194 2.81187325619842}
\DocumentationTok{\#\#                 ul}
\DocumentationTok{\#\# 1 2.90159967931239}
\DocumentationTok{\#\# 2  2.0711133146036}
\DocumentationTok{\#\# 3 5.65311806326377}
\DocumentationTok{\#\# 4  4.1133704022536}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{bootstrap}
\DocumentationTok{\#\#                         V1             mean                se               ll}
\DocumentationTok{\#\# 1                 Observed 2.63384609228479 0.117050780819442  2.4044307775164}
\DocumentationTok{\#\# 2             No Treatment 1.71983636149843 0.178094618476614 1.37077732344386}
\DocumentationTok{\#\# 3                Treatment 5.35072300362993 0.532149317613134 4.30772950671062}
\DocumentationTok{\#\# 4 Treatment {-} No Treatment  3.6308866421315 0.617094558399907 2.42140353261204}
\DocumentationTok{\#\#                 ul}
\DocumentationTok{\#\# 1 2.86326140705319}
\DocumentationTok{\#\# 2 2.06889539955299}
\DocumentationTok{\#\# 3 6.39371650054924}
\DocumentationTok{\#\# 4 4.84036975165097}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# 2.561855 , 4.580866}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\#  cli           3.6.0   2023{-}01{-}09 [1] CRAN (R 4.2.0)}
\DocumentationTok{\#\#  digest        0.6.31  2022{-}12{-}11 [1] CRAN (R 4.2.0)}
\DocumentationTok{\#\#  evaluate      0.20    2023{-}01{-}17 [1] CRAN (R 4.2.0)}
\DocumentationTok{\#\#  fastmap       1.1.1   2023{-}02{-}24 [1] CRAN (R 4.2.0)}
\DocumentationTok{\#\#  htmltools     0.5.4   2022{-}12{-}07 [1] CRAN (R 4.2.0)}
\DocumentationTok{\#\#  knitr         1.42.5  2023{-}03{-}15 [1] Github (yihui/knitr@c50d307)}
\DocumentationTok{\#\#  rlang         1.1.0   2023{-}03{-}14 [1] CRAN (R 4.2.0)}
\DocumentationTok{\#\#  rmarkdown     2.20    2023{-}01{-}19 [1] CRAN (R 4.2.0)}
\DocumentationTok{\#\#  rstudioapi    0.14    2022{-}08{-}22 [1] CRAN (R 4.2.0)}
\DocumentationTok{\#\#  sessioninfo   1.2.2   2021{-}12{-}06 [1] CRAN (R 4.2.0)}
\DocumentationTok{\#\#  xfun          0.37    2023{-}01{-}31 [1] CRAN (R 4.2.0)}
\DocumentationTok{\#\#  yaml          2.3.7   2023{-}01{-}23 [1] CRAN (R 4.2.0)}
\DocumentationTok{\#\# }
...
\NormalTok{ cli             }\DecValTok{3}\NormalTok{.}\FloatTok{6.0}   \DecValTok{2023{-}01{-}09}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.0}\NormalTok{)}
\NormalTok{ digest          }\DecValTok{0}\NormalTok{.}\FloatTok{6.31}  \DecValTok{2022{-}12{-}11}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.0}\NormalTok{)}
\NormalTok{ evaluate        }\FloatTok{0.20}    \DecValTok{2023{-}01{-}17}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.0}\NormalTok{)}
...
\NormalTok{ htmltools       }\DecValTok{0}\NormalTok{.}\FloatTok{5.4}   \DecValTok{2022{-}12{-}07}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.0}\NormalTok{)}
...
\NormalTok{ rlang           }\DecValTok{1}\NormalTok{.}\FloatTok{1.0}   \DecValTok{2023{-}03{-}14}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.0}\NormalTok{)}
\NormalTok{ rmarkdown       }\FloatTok{2.20}    \DecValTok{2023{-}01{-}19}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.0}\NormalTok{)}
\NormalTok{ rstudioapi      }\FloatTok{0.14}    \DecValTok{2022{-}08{-}22}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.0}\NormalTok{)}
...
\NormalTok{ yaml            }\DecValTok{2}\NormalTok{.}\FloatTok{3.7}   \DecValTok{2023{-}01{-}23}\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FunctionTok{CRAN}\NormalTok{ (R }\DecValTok{4}\NormalTok{.}\FloatTok{2.0}\NormalTok{)}
